...
void ParseFaceData( s_source_t *psource, int material, s_face_t *pFace )
{
    ...
    for ( j = 0; j < 3; j++ )
    {
        ...
        g_iLinecount++;
        i = sscanf( g_szLine, "%d %f %f %f %f %f %f %f %f %d %d %f %d %f %d %f %d %f", &bone, &p[0], &p[1], &p[2], &normal[0], &normal[1], &normal[2], &t[0], &t[1], &iCount, &bones[0], &weights[0], &bones[1], &weights[1], &bones[2], &weights[2], &bones[3], &weights[3] );
