...
class CFilePublishDialog : public Frame
{
   ...
   protected:
    ...
    {
        return false;
    }  // Force preview images to be square
    ...
    virtual const char *GetFileTypes( eFilterType_t eType = IMPORT_FILTER_NONE )
    {
        return "*.bsp";
    }
    virtual const char *GetFileTypeDescriptions( eFilterType_t eType = IMPORT_FILTER_NONE )
    {
        return "BSP Files (*.bsp)";
    }
    virtual const char *GetResFile() const
    {
        return "PublishFileDialog.res";
    }
