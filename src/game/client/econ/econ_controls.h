...
class CSimplePanelToolTip : public vgui::BaseTooltip
{
    ...
    {
        if ( m_pControlledPanel ) m_pControlledPanel->SetVisible( true );
    }
    virtual void HideTooltip()
    {
        if ( m_pControlledPanel ) m_pControlledPanel->SetVisible( false );
    }
    void SetControlledPanel( vgui::EditablePanel *pPanel )
    {
...
class CEconItemDetailsRichText : public CRichTextWithScrollbarBorders
{
    ...
    void AllowItemSetLinks( bool bAllow )
    {
        m_bAllowItemSetLinks = bAllow;
    }

    void SetLimitedItem( bool bLimited )
    {
...
class CExplanationPopup : public vgui::EditablePanel, public CGameEventListener
{
    ...
    void SetCalloutInParentsX( int nXPos )
    {
        m_iCalloutInParentsX = nXPos;
    }
    void SetCalloutInParentsY( int nYPos )
    {
        m_iCalloutInParentsY = nYPos;
    }
    void Popup( int iPosition = 0, int iTotalPanels = 0 );
    void Hide( int iExplanationDelta = 0 );
    const char *GetNextExplanation( void )
    {
        return m_szNextExplanation;
    }
...
class CGenericWaitingDialog : public vgui::EditablePanel
{
    ...
    {
        return "resource/UI/econ/GenericWaitingDialog.res";
    }
