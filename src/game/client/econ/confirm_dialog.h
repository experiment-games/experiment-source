...
class CConfirmDialog : public vgui::EditablePanel
{
   ...
   public:
    ...
    virtual GameActionSet_t GetPreferredActionSet() const
    {
   ...
   protected:
    ...
    virtual const char *GetCancelActionName() const
    {
        return nullptr;
    }
    virtual const char *GetConfirmActionName() const
    {
        return nullptr;
    }
...
class CTFReviveDialog : public CTFMessageBoxDialog
{
   ...
   public:
    ...
    {
        return "Resource/UI/ReviveDialog.res";
    }
    void SetOwner( CBaseEntity *pEntity );

    virtual GameActionSet_t GetPreferredActionSet() const OVERRIDE
    {
