...
// Purpose:
//-----------------------------------------------------------------------------
CBaseToolUsageDialog::CBaseToolUsageDialog( vgui::Panel *parent, const char *panelName, CEconItemView *pTool, CEconItemView *pToolSubject )
...
CConfirmStrangeRestrictionApplicationDialog::CConfirmStrangeRestrictionApplicationDialog( vgui::Panel *pParent, CEconItemView *pTool, CEconItemView *pToolSubject, int iStrangeSlot, const char *pszStatLocalizationToken )
    : CBaseToolUsageDialog( pParent, "ConfirmApplyStrangeRestrictionApplicationDialog", pTool, pToolSubject ), m_iStrangeSlot( iStrangeSlot ), m_pszStatLocalizationToken( pszStatLocalizationToken )
{
}
...
class CConfirmApplyStrangifierDialog : public CBaseToolUsageDialog
{
   ...
   public:
    ...
    {
        return "Resource/UI/econ/ConfirmApplyStrangifierDialog.res";
    }
