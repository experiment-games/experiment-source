...
// Purpose:
//-----------------------------------------------------------------------------
CItemPickupPanel::CItemPickupPanel( Panel *parent, bool bPopup )
    : Frame( parent, "item_pickup", bPopup )
{
...
// Purpose:
//-----------------------------------------------------------------------------
CItemDiscardPanel::CItemDiscardPanel( Panel *parent, bool bPopup )
    : Frame( parent, "item_discard", bPopup )
{
    vgui::VPANEL gameuiPanel = enginevgui->GetPanel( PANEL_GAMEUIDLL );
    SetParent( gameuiPanel );
