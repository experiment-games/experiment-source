...
class CBaseLoadoutPanel : public vgui::EditablePanel, public CGameEventListener
{
    ...
    virtual int GetNumSlotsPerPage( void )
    {
        return 1;
    }
    virtual int GetNumColumns( void )
    {
        return 99;
    }
    ...
    CItemModelPanel *GetMouseOverPanel( void )
    {
        return m_pMouseOverItemPanel;
    }
    CItemModelPanelToolTip *GetMouseOverToolTipPanel( void )
    {
