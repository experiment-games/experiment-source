...
void CStoreItemControlsPanel::ApplySchemeSettings( vgui::IScheme *pScheme )
{
    ...
    LoadControlSettings(
        ShouldUseNewStore() ? "Resource/UI/econ/store/v2/StoreItemControls.res" : "Resource/UI/econ/store/v1/StoreItemControls.res" );
}
...
{
    return ( pEntry->GetItemDefinitionIndex() == InventoryManager()->GetLocalInventory()->GetPreviewItemDef() ) && !pEntry->IsOnSale( eCurrency );
}
...
// Purpose:
//-----------------------------------------------------------------------------
CStorePage::CStorePage( Panel *parent, const CEconStoreCategoryManager::StoreCategory_t *pPageData, const char *pPreviewItemResFile )
    : vgui::PropertyPage( parent, "StorePage" )
{
