...
class CStorePreviewItemIcon : public CBaseStorePreviewIcon
{
    ...
    CItemModelPanel *GetItemPanel( void )
    {
        return m_pItemPanel;
    }
...
class CStoreItemControlsPanel : public vgui::EditablePanel
{
    ...
    CItemModelPanel *GetItemModelPanel()
    {
...
class CStorePage : public vgui::PropertyPage, public CGameEventListener
{
    ...
    int GetNumItemPanels( void )
    {
        return m_iItemPanels;
    }
    int GetNumColumns( void )
    {
        return m_iItemColumns;
    }
    ...
    {
        return m_pPageData ? m_pPageData->m_pchName : NULL;
    }

    virtual bool FindAndSelectEntry( const econ_store_entry_t *pEntry );

    CItemModelPanelToolTip *GetItemTooltip( void )
    {
    ...
    {
        return true;
    }  // Allow derived classes to add an additional
