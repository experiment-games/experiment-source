...
class CTFStatPanel : public EditablePanel, public CHudElement
{
    ...
    void ShowStatPanel( int iClass, int iTeam, int iCurStatValue, TFStatType_t statType, RecordBreakType_t recordBreakType, bool bAlive );
    ...
    bool IsLocalFileTrusted()
    {
        return m_bLocalFileTrusted;
    }
    void SetStatsChanged( bool bChanged )
    {
        m_bStatsChanged = bChanged;
    }
