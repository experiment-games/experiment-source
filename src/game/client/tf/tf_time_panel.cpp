...
// Purpose:
//-----------------------------------------------------------------------------
CTFHudTimeStatus::CTFHudTimeStatus( Panel *parent, const char *name )
...
CTFHudKothTimeStatus::CTFHudKothTimeStatus( const char *pElementName )
    : CHudElement( pElementName ), BaseClass( NULL, "HudKothTimeStatus" ), m_pBluePanel( NULL ), m_pRedPanel( NULL ), m_pActiveTimerBG( NULL ), m_nActiveTeam( TEAM_UNASSIGNED )
{
