...
CON_COMMAND( cl_coach_toggle, "Toggle coach status" )
{
    ...
    if ( BInCoachesList() )
    {
        ShowConfirmDialog( "#TF_Coach_RemoveCoach_Title", "#TF_Coach_RemoveCoach_Text", "#TF_Coach_Yes", "#TF_Coach_No", &ToggleCoachingConfirm );
    }
    else
    {
        ShowConfirmDialog( "#TF_Coach_AddCoach_Title", "#TF_Coach_AddCoach_Text", "#TF_Coach_Yes", "#TF_Coach_No", &ToggleCoachingConfirm );
    }
}
...
static void PromptFindCoach()
{
    ...
    {
        ShowConfirmDialog( "#TF_Coach_AskStudent_Title", "#TF_Coach_AskStudent_Text", "#TF_Coach_Yes", "#TF_Coach_No", &FindCoach );
    }
}
...
class CGCCoaching_FindCoachResponse : public GCSDK::CGCClientJob
{
   public:
    ...
    virtual bool BYieldingRunGCJob( GCSDK::IMsgNetPacket *pNetPacket )
    {
        ...
        {
            // retry?
            ShowConfirmDialog( "#TF_Coach_StudentRetry_Title", "#TF_Coach_StudentRetry_Text", "#TF_Coach_Yes", "#TF_Coach_No", &FindCoach );
        }
        return true;
    }
};
...
static void PromptIfLikeCoach()
{
    if ( g_bCanLikeCoach )
    {
        ShowConfirmDialog( "#TF_Coach_LikeCoach_Title", "#TF_Coach_LikeCoach_Text", "#TF_Coach_Yes", "#TF_Coach_No", &LikeCoachCallback );
    }
}
...
void Coaching_CheckIfEligibleForCoaching()
{
    ...
    {
        ShowConfirmOptOutDialog( "#TF_Coach_AskStudent_Title", "#TF_Coach_AskStudent_Text", "#TF_Coach_Yes", "#TF_Coach_No", "#TF_Coach_AskStudent_DoNotShowAgain", "tf_coach_request_nevershowagain", &FindCoach );
    }
}
