...
class C_BaseObject : public C_BaseCombatCharacter, public IHasBuildPoints, public ITargetIDProvidesHint, public IBaseObjectAutoList
{
    ...
    virtual bool IsAnUpgrade( void ) const
    {
        return false;
    }
    ...
    float GetPercentageConstructed( void )
    {
        return m_flPercentageConstructed;
    }

    bool IsPlacing( void ) const
    {
        return m_bPlacing;
    }
    ...
    virtual int GetUpgradeMetalRequired( void )
    {
        return m_iUpgradeMetalRequired;
    }
    ...
    bool IsEnteringOrExitingFullyInvisible( float flValue )
    {
    ...
    {
        return m_hBuiltOnEntity.IsValid();
    }
