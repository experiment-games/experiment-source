...
class CTFHudRobotDestruction_RobotIndicator : public vgui::EditablePanel
{
   ...
   public:
    ...
    void UpdateState();
    eRobotUIState GetState() const
    {
        return m_eState;
    }
    const CTFRobotDestruction_RobotGroup *GetGroup() const
    {
        return m_hGroup.Get();
    }
    void SetNextRobotIndicator( CTFHudRobotDestruction_RobotIndicator *pNext )
    {
        m_pNextRobotIndicator = pNext;
    }
    void SetPrevRobotIndicator( CTFHudRobotDestruction_RobotIndicator *pPrev )
    {
   ...
   private:
    ...
    class CProgressPanel : public ImagePanel, public CGameEventListener
    {
       ...
       public:
        ...
        void Blink();
        void SetApproachSpeed( float flApproachSpeed )
        {
            m_flApproachSpeed = flApproachSpeed;
        }
