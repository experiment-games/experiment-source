...
static const char *GetBallImageForTeam( int iTeam )
{
    ...
    {
        case TF_TEAM_RED:
            return "../passtime/hud/passtime_ball_offscreen_red";
        case TF_TEAM_BLUE:
            return "../passtime/hud/passtime_ball_offscreen_blue";
        default:
...
CTFHudPasstimeOffscreenArrow::CTFHudPasstimeOffscreenArrow( Panel *parent, const char *name )
    : EditablePanel( parent, name ), m_pArrowMaterial( 0 ), m_pImage( 0 )
{
}
...
void CTFHudPasstimeOffscreenArrow::PaintBackground()
{
    ...
    Vector vecEntPos = pEnt->WorldSpaceCenter();
    {
        ...
        const bool bCenterOfScreen =
            ( vecActualProjection.x < 1.0f ) && ( vecActualProjection.x > -1.0f ) && ( vecActualProjection.y < 1.0f ) && ( vecActualProjection.y > -1.0f );
...
CTFHudPasstimePlayerOffscreenArrow::CTFHudPasstimePlayerOffscreenArrow( vgui::Panel *pParent, int iPlayerIndex )
    : BaseClass( pParent, "PasstimePlayerOffscreenArrow" ), m_iPlayerIndex( iPlayerIndex )
{
}
