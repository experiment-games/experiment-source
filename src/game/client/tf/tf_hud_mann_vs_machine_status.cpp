...
CEnemyCountPanel::CEnemyCountPanel( Panel *parent, const char *pName )
...
CMvMBossProgressBar::CMvMBossProgressBar( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
...
CMvMBossStatusPanel::CMvMBossStatusPanel( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
...
CWaveStatusPanel::CWaveStatusPanel( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
...
CCurrencyStatusPanel::CCurrencyStatusPanel( const char *pElementName )
    : CHudElement( pElementName ), vgui::EditablePanel( NULL, "CurrencyStatusPanel" )
{
...
CInWorldCurrencyStatus::CInWorldCurrencyStatus( Panel *parent, const char *name )
...
CWarningSwoop::CWarningSwoop( Panel *parent, const char *name )
...
CWaveCompleteSummaryPanel::CWaveCompleteSummaryPanel( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
    m_eState = FINISHED;
...
CVictorySplash::CVictorySplash( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
}
...
CMvMBombCarrierProgress::CMvMBombCarrierProgress( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
}
            ...
            if ( pPlayer )
            {
                switch ( nTime )
                {
                    case 10:
                        ...
                        break;
                    case 5:
                        pPlayer->EmitSound( "Announcer.RoundBegins5Seconds" );
                        break;
                    case 4:
                        pPlayer->EmitSound( "Announcer.RoundBegins4Seconds" );
                        break;
                    case 3:
                        pPlayer->EmitSound( "Announcer.RoundBegins3Seconds" );
                        break;
                    case 2:
                        pPlayer->EmitSound( "Announcer.RoundBegins2Seconds" );
                        break;
                    case 1:
                        pPlayer->EmitSound( "Announcer.RoundBegins1Seconds" );
                        break;
                }
            }
        }
