...
class CQuestObjectiveTextPanel : public vgui::EditablePanel
{
   ...
   public:
    ...
    {
        return m_objective.GetPointsType();
    }
    int GetPoints() const
    {
        return m_objective.GetPoints();
    }
    ...
    {
        return m_objective.GetObjectiveDef()->GetDefIndex();
    }
    const CQuestObjectiveDefinition* GetObjective() const
    {
        return m_objective.GetObjectiveDef();
    }
...
class CQuestProgressTrackerPanel : public vgui::EditablePanel, public CGameEventListener
{
   ...
   public:
    ...
    const CQuestDefinition* GetQuestDef() const
    {
        return m_pQuestDef;
    }
    bool IsValidForLocalPlayer() const;

    const CUtlVector< CQuestObjectiveTextPanel* >& GetAttributePanels() const
    {
   ...
   protected:
    ...
    {
        PointsView_t();
        bool BIsDoneProgressing() const
        {
            return m_flCurrentProgress == m_flTargetProgress;
        }
