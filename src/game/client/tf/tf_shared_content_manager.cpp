...
C_TFSharedContentManager *TFSharedContentManager()
{
    return &s_SharedContentManager;
}
...
static void PromptAcceptRomevisionSharing()
{
    ...
    {
        ShowConfirmOptOutDialog( "#TF_Prompt_Romevision_Title", "#TF_Prompt_Romevision_Message", "#TF_Prompt_Romevsion_OK", "#TF_Prompt_Romevsion_Cancel", "#TF_Prompt_Romevsion_Opt_Out", "tf_romevision_skip_prompt", PromptAcceptRomevisionSharingCallback, NULL );
    }
}
