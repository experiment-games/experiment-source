...
CPublishedFiles::CPublishedFiles()
    : m_nTotalFilesToQuery( 0 ), m_nFileQueryTime( 0 ), m_bQueryErrorOccurred( false ), m_state( kState_Initialized ), m_unEnumerateStartPage( 0 ), m_nCurrentQueryPublishedFileID( 0 )
{
