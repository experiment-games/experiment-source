...
class C_TFPlayer : public C_BasePlayer, public IHasAttributes, public IInventoryUpdateListener, public C_TFMvMBossProgressUser
{
    ...
    const C_TFPlayerClass *GetPlayerClass( void ) const
    {
        return &m_PlayerClass;
    }
    C_TFPlayerClass *GetPlayerClass( void )
    {
        return &m_PlayerClass;
    }
    ...
    {
        return GetPercentInvisible() > 0.f;
    }
    ...
    void SetWasHealedByLocalPlayer( bool bState )
    {
        m_bWasHealedByLocalPlayer = bState;
    }
    void GetHealer( C_TFPlayer **pHealer, float *flChargeLevel )
    {
        *pHealer = m_hHealer;
        *flChargeLevel = m_flHealerChargeLevel;
    }
    bool GetWasHealedByLocalPlayer()
    {
        return m_bWasHealedByLocalPlayer;
    }
    ...
    CUtlVector< EHANDLE > *GetSpawnedGibs( void )
    {
        return &m_hSpawnedGibs;
    }
    ...
    {
        return tf_medigun_autoheal.GetBool();
    }
    ...
    float GetLastDamageTimeMvMOnly( void ) const
    {
        return m_flMvMLastDamageTime;
    }
    ...
    int GetActiveTauntSlot() const
    {
        return m_nActiveTauntSlot;
    }
    ...
    {
        return m_flHeadScale;
    }
    float GetTorsoScale() const
    {
        return m_flTorsoScale;
    }
    float GetHandScale() const
    {
        return m_flHandScale;
    }
    float GetLastResistTime() const
    {
        return m_flLastResistTime;
    }
    ...
    CMaterialReference *GetInvulnMaterialRef( void )
    {
        return &m_InvulnerableMaterial;
    }
    ...
    const char *GetEyeGlowEffect()
    {
        return m_pszEyeGlowEffectName;
    }
    Vector GetEyeGlowColor( bool bAlternate )
    {
        return bAlternate ? m_vEyeGlowColor1 : m_vEyeGlowColor2;
    }
    ...
    // Matchmaking
    bool GetMatchSafeToLeave()
    {
        return m_bMatchSafeToLeave;
    }

    // Halloween silliness.
    void HalloweenBombHeadUpdate( void );

    bool IsUsingVRHeadset( void )
    {
        return m_bUsingVRHeadset;
    }
    ...
    */
    ...
    void SetFootStamps( int nFootStamps )
    {
        m_nFootStamps = nFootStamps;
    }
    ...
    bool ShouldShowHudMenuTauntSelection() const
    {
    ...
    void SetUsingActionSlot( bool bUsingActionSlot )
    {
        m_bUsingActionSlot = bUsingActionSlot;
    }
    ...
    void SetInspectTime( float flInspectTime )
    {
        m_flInspectTime = flInspectTime;
    }
    bool IsInspecting() const;
    void HandleInspectHint();

    void SetHelpmeButtonPressedTime( float flPressTime )
    {
        m_flHelpmeButtonPressTime = flPressTime;
    }
...
class C_TFPlayerPreviewEffect
{
    ...
    {
        m_nPreviewEffect = nEffect;
    }
    PREVIEW_EFFECT GetEffect() const
    {
        return m_nPreviewEffect;
    }
...
class C_TFRagdoll : public C_BaseFlex
{
    ...
    C_TFPlayer *GetPlayer( void ) const
    {
        return m_hPlayer;
    }

    bool IsRagdollVisible();
    float GetBurnStartTime()
    {
        return m_flBurnEffectStartTime;
    }
