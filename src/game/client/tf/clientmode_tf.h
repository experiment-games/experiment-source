...
class ClientModeTFNormal : public ClientModeShared
{
    ...
    static bool BuildRichPresenceStatusDirect( wchar_t *pwzOutStatus, size_t uOutSizeBytes, const char *pszState, const char *pszMatchGroupLocToken, const char *pszPrettyMapName );
    // Safe version
    template < size_t maxLenInChars >
    static inline bool BuildRichPresenceStatus( OUT_Z_ARRAY wchar_t ( &pwzOutStatus )[maxLenInChars],
                                                const char *pszState,
                                                const char *pszMatchGroupLocToken,
                                                const char *pszPrettyMapName )
    {
        return BuildRichPresenceStatusDirect( pwzOutStatus, maxLenInChars, pszState, pszMatchGroupLocToken, pszPrettyMapName );
    }
