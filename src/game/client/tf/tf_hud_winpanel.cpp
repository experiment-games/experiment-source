...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFWinPanel::CTFWinPanel( const char *pElementName )
    : EditablePanel( NULL, "WinPanel" ), CHudElement( pElementName )
{
    ...
    else if ( Q_strcmp( "teamplay_win_panel", pEventName ) == 0 )
    {
        ...
        switch ( iWinReason )
        {
            ...
            case WINREASON_FLAG_CAPTURE_LIMIT:
            {
                ...
                g_pVGuiLocalize->ConstructString_safe( wzWinReason, wpszFormatString, 2, pLocalizedTeamName, wzFlagCaptureLimit );
            }
            break;
            ...
            case WINREASON_SCORED:
            {
                ...
                g_pVGuiLocalize->ConstructString_safe( wzWinReason, wpszFormatString, 2, pLocalizedTeamName, wzScoreLimit );
            }
            break;
