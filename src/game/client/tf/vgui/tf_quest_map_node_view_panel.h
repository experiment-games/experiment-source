...
class CQuestObjectiveTooltip : public vgui::BaseTooltip
{
    ...
    void SetObjectivePanel( CQuestObjectivePanel* pObjectivePanel )
    {
...
class CQuestViewSubPanel : public CExpandablePanel, public CGameEventListener
{
    ...
    const CQuestDefinition* GetQuestDefindex() const
    {
        return m_pQuestDef;
    }
    ...
    void SetTextTooltip( CTFTextToolTip* pTextTooltip )
    {
        m_pToolTip = pTextTooltip;
    }
    void SetObjectiveTooltip( CQuestObjectiveTooltip* pObjectiveTooltip )
    {
        m_pObjectiveTooltip = pObjectiveTooltip;
    }
...
class CQuestNodeViewPanel : public CExpandablePanel, public CLocalSteamSharedObjectListener, public CGameEventListener
{
    ...
    void SetItemModelPanelTooltip( CItemModelPanelToolTip* pItemTooltip )
    {
        m_pItemToolTip = pItemTooltip;
    }
    void SetTextTooltip( CTFTextToolTip* pTooltip );
    void SetObjectiveTooltip( CQuestObjectiveTooltip* pObjectiveTooltip );
    void SetData( const CSOQuestMapNode& msgNodeData );
    const CSOQuestMapNode GetData() const
    {
        return m_msgNodeData;
    }
