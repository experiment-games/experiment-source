...
CCompStatsPanel::CCompStatsPanel( vgui::Panel* pParent, const char* pszName )
    : BaseClass( pParent, pszName ), m_pCompetitiveModeLeaderboard( NULL ), m_pMatchHistoryScroller( NULL ), m_eMatchSortMethod( SORT_BY_DATE ), m_bDescendingMatchHistorySort( true )
{
