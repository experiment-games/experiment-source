...
class CLoadoutItemOptionsPanel : public vgui::EditablePanel
{
   ...
   public:
    ...
    loadout_positions_t GetItemSlot() const
    {
        return m_eItemSlot;
    }
...
class CClassLoadoutPanel : public CBaseLoadoutPanel
{
   ...
   public:
    ...
    {
        return NUM_ITEM_PANELS_IN_LOADOUT;
    };
    ...
    void SetSelectionPanel( CEquipSlotItemSelectionPanel *pPanel )
    {
        m_pSelectionPanel = pPanel;
    }
    void UpdatePassiveAttributes( void );

    bool IsInSelectionPanel() const
    {
        return m_pSelectionPanel != NULL;
    }
    CEquipSlotItemSelectionPanel *GetItemSelectionPanel()
    {
        return m_pSelectionPanel;
    }

    bool IsEditingTauntSlots() const
    {
        return m_bInTauntLoadoutMode;
    }
