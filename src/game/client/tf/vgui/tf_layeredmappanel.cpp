...
// CLayeredMapToolTip
//=========================================================
CLayeredMapToolTip::CLayeredMapToolTip( vgui::Panel *parent, const char *text )
...
CTFLayeredMapItemPanel::CTFLayeredMapItemPanel( Panel *parent, const char *pName )
...
CTFLayeredMapPanel::CTFLayeredMapPanel( Panel *parent, const char *pName )
    : vgui::EditablePanel( parent, pName )
{
