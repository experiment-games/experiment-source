...
CQuestNotificationPanel::CQuestNotificationPanel( const char* pszElementName )
    : CHudElement( pszElementName ), EditablePanel( NULL, "QuestNotificationPanel" ), m_flTimeSinceLastShown( 0.f ), m_bIsPresenting( false ), m_bInitialized( false ), m_pMainContainer( NULL )
{
