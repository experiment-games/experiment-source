...
class CQuestMapItemAdPanel : public CItemAdPanel
{
    ...
    const CQuestMapStoreItem* GetDefinition() const
    {
...
// Purpose:
//-----------------------------------------------------------------------------
class CQuestMapPanel : public EditablePanel, public CGameEventListener, public CLocalSteamSharedObjectListener
{
    ...
    CTFTextToolTip* GetTextTooltip() const
    {
        return m_pToolTip;
    }
