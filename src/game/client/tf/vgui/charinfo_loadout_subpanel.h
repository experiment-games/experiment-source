...
class CCharInfoLoadoutSubPanel : public vgui::PropertyPage
{
   ...
   public:
    ...
    void OpenToBackpack( void )
    {
        OpenSubPanel( CHAP_BACKPACK );
    }
    void OpenToCrafting( void )
    {
        OpenSubPanel( CHAP_CRAFTING );
    }
    void OpenToArmory( int iItemDef = 0 )
    {
        m_iArmoryItemDef = iItemDef;
        OpenSubPanel( CHAP_ARMORY );
    }
    ...
    CClassLoadoutPanel *GetClassLoadoutPanel( void )
    {
        return m_pClassLoadoutPanel;
    }
    CBackpackPanel *GetBackpackPanel( void )
    {
        return m_pBackpackPanel;
    }
    CCraftingPanel *GetCraftingPanel( void )
    {
        return m_pCraftingPanel;
    }
    CArmoryPanel *GetArmoryPanel( void )
    {
        return m_pArmoryPanel;
    }
    CTFItemInspectionPanel *GetInspectionPanel( void )
    {
        return m_pInspectPanel;
    }
    ...
    {
        return ( m_iShowingPanel == CHAP_LOADOUT && m_iCurrentClassIndex == TF_CLASS_UNDEFINED );
    }

    charinfo_activepanels_t GetShowingPanel() const
    {
        return m_iShowingPanel;
    }
    int GetCurrentClassIndex() const
    {
        return m_iCurrentClassIndex;
    }
