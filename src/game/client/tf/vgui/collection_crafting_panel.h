...
class CCollectionCraftingSelectionPanel : public CItemCriteriaSelectionPanel
{
   ...
   public:
    ...
    virtual bool ShouldDeleteOnClose( void ) OVERRIDE
    {
        return false;
    }
...
class CCollectionCraftingPanel : public vgui::EditablePanel, public CGameEventListener, public CLocalSteamSharedObjectListener
{
   public:
    ...
    {
        return "Resource/UI/econ/CollectionCraftingDialog.res";
    }
    ...
    {
        return COLLECTION_CRAFTING_ITEM_COUNT;
    }
...
class CCraftCommonStatClockPanel : public CCollectionCraftingPanel
{
   public:
    ...
    virtual const char *GetResFile( void )
    {
        return "Resource/UI/econ/MannCoTrade_CommonStatClock.res";
    }
    virtual void OnCommand( const char *command ) OVERRIDE;

    virtual int GetInputItemCount()
    {
        return CRAFT_COMMON_STATCLOCK_ITEM_COUNT;
    }
    virtual int GetOutputItemCount()
    {
        return 1;
