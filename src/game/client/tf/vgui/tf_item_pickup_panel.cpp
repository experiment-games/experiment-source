...
// Purpose:
//-----------------------------------------------------------------------------
CTFItemPickupPanel::CTFItemPickupPanel( Panel *parent )
    : CItemPickupPanel( parent, false )
{
    m_pClassImage = NULL;
...
// Purpose:
//-----------------------------------------------------------------------------
CTFItemDiscardPanel::CTFItemDiscardPanel( Panel *parent )
    : CItemDiscardPanel( parent )
{
