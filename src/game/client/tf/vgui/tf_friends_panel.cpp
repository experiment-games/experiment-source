        ...
        else
        {
            ...
            switch ( eState )
            {
                case k_EPersonaStateOffline:
                    pwzStatus = g_pVGuiLocalize->Find( "#TF_Friends_Offline" );
                    break;
                case k_EPersonaStateOnline:
                    pwzStatus = g_pVGuiLocalize->Find( "#TF_Friends_Online" );
                    break;
                case k_EPersonaStateBusy:
                    pwzStatus = g_pVGuiLocalize->Find( "#TF_Friends_Busy" );
                    break;
                case k_EPersonaStateAway:
                    pwzStatus = g_pVGuiLocalize->Find( "#TF_Friends_Away" );
                    break;
                case k_EPersonaStateSnooze:
                    pwzStatus = g_pVGuiLocalize->Find( "#TF_Friends_Snooze" );
                    break;
            }
...
CSteamFriendsListPanel::CSteamFriendsListPanel( Panel *parent, const char *panelName )
    : BaseClass( parent, panelName ), m_sPersonaStateChangedCallback( this, &CSteamFriendsListPanel::OnPersonaStateChanged ), m_sRichPresenceStateChangedCallback( this, &CSteamFriendsListPanel::OnRichPresenceChanged )
{
