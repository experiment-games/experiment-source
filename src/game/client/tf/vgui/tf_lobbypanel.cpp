...
CBaseLobbyPanel::CBaseLobbyPanel( vgui::Panel *pParent, CBaseLobbyContainerFrame *pContainer )
    : vgui::PropertySheet( pParent, "LobbyPanel" ), m_sPersonaStateChangedCallback( this, &CBaseLobbyPanel::OnPersonaStateChanged ), m_pContainer( pContainer )
{
    ...
    m_pChatTextEntry = new ChatTextEntry( m_pPartyActiveGroupBox, "ChatTextEntry" );
    Assert( m_pChatTextEntry );
    m_pChatLog = new ChatLog( m_pPartyActiveGroupBox, "ChatLog" );
    Assert( m_pChatLog );
...
void CBaseLobbyPanel::ApplySchemeSettings( vgui::IScheme *pScheme )
{
    ...
    m_pSearchActiveGroupBox = dynamic_cast< vgui::EditablePanel * >( FindChildByName( "SearchActiveGroupBox", true ) );
    Assert( m_pSearchActiveGroupBox );
    m_pSearchActiveTitleLabel = dynamic_cast< vgui::Label * >( FindChildByName( "SearchActiveTitle", true ) );
    Assert( m_pSearchActiveTitleLabel );
    m_pSearchActivePenaltyLabel = dynamic_cast< vgui::Label * >( FindChildByName( "PartyHasLowPriorityLabel", true ) );
    Assert( m_pSearchActivePenaltyLabel );

    m_pPartyHasLowPriority = dynamic_cast< vgui::EditablePanel * >( FindChildByName( "PartyHasLowPriorityGroupBox", true ) );
    Assert( m_pPartyHasLowPriority );

    m_pJoinLateCheckButton = dynamic_cast< vgui::CheckButton * >( FindChildByName( "JoinLateCheckButton", true ) );
    Assert( m_pJoinLateCheckButton );
    m_pJoinLateValueLabel = dynamic_cast< vgui::Label * >( FindChildByName( "JoinLateValueLabel", true ) );
    Assert( m_pJoinLateValueLabel );

    m_pInviteButton = dynamic_cast< vgui::Button * >( FindChildByName( "InviteButton", true ) );
    Assert( m_pInviteButton );
