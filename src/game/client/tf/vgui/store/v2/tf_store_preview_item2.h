...
class CFullscreenStorePreviewItem : public EditablePanel
{
   ...
   private:
    ...
    struct Stats_t
    {
        ...
        void Clear()
        {
            V_memset( this, 0, sizeof( Stats_t ) );
        }
...
class CTFStorePreviewItemPanel2 : public CTFStorePreviewItemPanelBase
{
   ...
   protected:
    ...
    int PlaceControl( Panel *pParent, const char *pControlNameA, const char *pControlNameB, int nOffset, bool bVertical, bool bSizeAToContents = true, bool bUseContentSize = true );
    void DoClose();
    void Clear();
