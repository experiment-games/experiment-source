...
//-----------------------------------------------------------------------------
CCharacterInfoPanel::CCharacterInfoPanel( Panel *parent )
    : PropertyDialog( parent, "character_info" )
{
...
// Purpose:
//-----------------------------------------------------------------------------
CServerNotConnectedToSteamDialog::CServerNotConnectedToSteamDialog( vgui::Panel *pParent, const char *pElementName )
    : BaseClass( pParent, "ServerNotConnectedToSteamDialog" )
{
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CCharacterInfoPanel::Gamestats_Store( int eventID, CEconItemView *item, const char *panelName, int classId, const cart_item_t *cartItem, int checkoutAttempts, const char *storeError, int totalPrice, int currencyCode )
{
...
// Purpose:
//-----------------------------------------------------------------------------
CCheatDetectionDialog::CCheatDetectionDialog( vgui::Panel *pParent, const char *pElementName )
    : BaseClass( pParent, "CheatDetectionDialog" )
{
}
