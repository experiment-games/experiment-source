...
class CRecipeComponentItemModelPanel : public CItemModelPanel
{
    ...
    CEconItemView *GetDefaultItem() const
    {
        return m_nPageNumber < m_vecDefaultItems.Count() ? m_vecDefaultItems[m_nPageNumber] : NULL;
    }
...
class CInputPanelItemModelPanel : public CRecipeComponentItemModelPanel
{
    ...
    void SetDynamicRecipeItem( const CEconItemView *pDynamicRecipeItem )
    {
...
class CDynamicRecipePanel : public CBackpackPanel
{
    ...
    {
        return "Resource/UI/DynamicRecipePanel.res";
    }
    ...
    int GetNumBackpackPanelsPerPage() const
    {
        return DYNAMIC_RECIPE_BACKPACK_ROWS * DYNAMIC_RECIPE_BACKPACK_COLS;
    }
    virtual int GetNumPages() OVERRIDE;
    virtual void SetCurrentPage( int nNewPage ) OVERRIDE;
    int GetFirstBackpackIndex() const
    {
        return DYNAMIC_RECIPE_INPUT_COUNT + DYNAMIC_RECIPE_OUTPUT_COUNT;
    }

    void SetCurrentInputPage( int nNewPage );
    int GetNumInputPages() const;
    int GetNumInputPanelsPerPage() const
    {
        return DYNAMIC_RECIPE_INPUT_COUNT;
    }

    int GetNumOutputPage() const;
    int GetNumOutputPanelsPerPage() const
    {
        return DYNAMIC_RECIPE_OUTPUT_COUNT;
    }
    ...
    class CDynamicRecipeItemMatchFind : public CEconItemSpecificAttributeIterator
    {
        ...
        virtual bool OnIterateAttributeValue( const CEconItemAttributeDefinition *pAttrDef, const CAttribute_DynamicRecipeComponent &value ) OVERRIDE;
        bool MatchesAnyAttributes() const
        {
