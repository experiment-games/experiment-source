...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFTeamButton::CTFTeamButton( vgui::Panel *parent, const char *panelName )
    : CExButton( parent, panelName, "" )
{
    m_szModelPanel[0] = '\0';
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFTeamMenu::CTFTeamMenu( IViewPort *pViewPort )
    : CTeamMenu( pViewPort )
{
...
void CTFTeamMenu::ActivateSelectIconHint( int focus_group_number )
{
    ...
    {
        case 1:
            icon = m_pJoinAutoHintIcon;
            break;
        case 2:
            icon = m_pJoinSpectatorsHintIcon;
            break;
        case 3:
            icon = m_pJoinBluHintIcon;
            break;
        case 4:
            icon = m_pJoinRedHintIcon;
            break;
    }
