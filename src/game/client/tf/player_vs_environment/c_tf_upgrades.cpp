...
CUpgradeBuyPanel::CUpgradeBuyPanel( Panel *parent, const char *panelName )
...
// Purpose:
//-----------------------------------------------------------------------------
CHudUpgradePanel::CHudUpgradePanel( const char *pElementName )
    : CHudElement( pElementName ), BaseClass( NULL, "HudUpgradePanel" )
{
    ...
    for ( int nSlotIndex = 0; nSlotIndex < ARRAYSIZE( m_ItemSlotBuyPanels ); ++nSlotIndex )
    {
        ...
        if ( pItemSlotBuyPanel->nSlot != -2 )
        {
            ...
            FOR_EACH_VEC( g_MannVsMachineUpgrades.m_Upgrades, i )
            {
                ...
                int nCost = pItemSlotBuyPanel->nSlot >= 0 ? TFGameRules()->GetCostForUpgrade( &( g_MannVsMachineUpgrades.m_Upgrades[i] ), pItemSlotBuyPanel->nSlot, m_hPlayer->GetPlayerClass()->GetClassIndex(), m_hPlayer ) : g_MannVsMachineUpgrades.m_Upgrades[i].nCost;
