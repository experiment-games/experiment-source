...
class CUpgradeBuyPanel : public vgui::EditablePanel
{
   ...
   public:
    ...
    void SetInspectMode( bool bValue )
    {
        m_bInspectMode = bValue;
    }
...
struct ItemSlotBuyPanels
{
    ...
    void SetItemID( itemid_t iIndex )
    {
        m_iItemID = iIndex;
    }
    itemid_t GetItemID( void )
    {
        return m_iItemID;
    }
...
class CHudUpgradePanel : public CHudElement, public vgui::EditablePanel
{
   ...
   public:
    ...
    void InspectUpgradesForPlayer( C_TFPlayer *pPlayer )
    {
        m_hPlayer = pPlayer;
        m_bInspectMode = true;
        m_bShowUpgradeMenu = true;
    }
    C_TFPlayer *GetPlayer( void )
    {
        return m_hPlayer;
    }
