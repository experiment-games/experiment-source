...
// TODO: Remove this. We moved this to Panel so we don't have to juggle multiple inheritance
// just to get the Lua stuff for all panel classes.
//namespace vgui
//{
//
////-----------------------------------------------------------------------------
...
//    }
//
//    // Member classes override this to customize with which metatable
