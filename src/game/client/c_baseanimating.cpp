...
ConVar cl_threaded_bone_setup( "cl_threaded_bone_setup", "0", FCVAR_DEVELOPMENTONLY | FCVAR_INTERNAL_USE, "Enable parallel processing of C_BaseAnimating::SetupBones()" );
...
class MaterialOverrideRestore
{
   public:
    MaterialOverrideRestore()
        : m_bRestore( false ), m_pOverrideMaterial( NULL ), m_nOverrideType( OVERRIDE_NORMAL )
    {
    }
