...
class CReplayPerformanceSaveDlg : public EditablePanel
{
   ...
   public:
    ...
    static void Show( OnConfirmSaveCallback pfnCallback, void *pContext, CReplay *pReplay, bool bExitEditorWhenDone );
...
/*static*/ void CReplayPerformanceSaveDlg::Show( OnConfirmSaveCallback pfnCallback, void *pContext, CReplay *pReplay, bool bExitEditorWhenDone )
{
    Assert( !ms_hDlg.Get() );
...
bool CReplayPerformanceSaveDlg::ConfirmOverwriteOrSaveNow()
{
    ...
    {
        ShowConfirmDialog( "#Replay_OverwriteDlgTitle", "#Replay_OverwriteDlgText", "#Replay_ConfirmOverwrite", "#Replay_Cancel", OnConfirmOverwrite, NULL, this );
        return false;
    }
