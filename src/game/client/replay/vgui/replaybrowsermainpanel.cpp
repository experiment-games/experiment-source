...
// Purpose:
//-----------------------------------------------------------------------------
void CReplayBrowserPanel::ShowPanel( bool bShow, ReplayHandle_t hReplayDetails /*=REPLAY_HANDLE_INVALID*/, int iPerformance /*=-1*/ )
{
    if ( bShow )
    {
...
// Purpose:
//-----------------------------------------------------------------------------
void CReplayBrowserPanel::AttemptToDeleteReplayItem( Panel *pHandler, ReplayItemHandle_t hReplayItem, IReplayItemManager *pItemManager, int iPerformance )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CReplayBrowserPanel::ConfirmReplayItemDelete( Panel *pHandler, ReplayItemHandle_t hReplayItem, IReplayItemManager *pItemManager, int iPerformance )
{
