...
class CCameraOptionsPanel : public EditablePanel
{
   ...
   public:
    ...
    void AddSliderToLayout( int nId, Slider *pSlider, const char *pLabelText, float flMinValue, float flMaxValue, float &flOut )
    {
...
void CReplayPerformanceEditorPanel::ApplySchemeSettings( IScheme *pScheme )
{
    ...
    static const char *s_pControlButtonNames[NUM_CTRLBUTTONS] = {
        "InButton", "GotoBeginningButton", "RewindButton", "PlayButton", "FastForwardButton", "GotoEndButton", "OutButton" };
