...
// Purpose: Konstructor
//-----------------------------------------------------------------------------
CExperimentClientScoreBoardDialog::CExperimentClientScoreBoardDialog( IViewPort *pViewPort )
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CExperimentClientScoreBoardDialog::~CExperimentClientScoreBoardDialog()
{
}
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::PaintBackground()
{
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::PaintBorder()
{
    int x1, x2, y1, y2;
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::InitScoreboardSections()
{
    m_pPlayerList->SetBgColor( Color( 0, 0, 0, 0 ) );
    m_pPlayerList->SetBorder( NULL );
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::UpdateTeamInfo()
{
    if ( g_PR == NULL )
        return;
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::AddHeader()
{
    // add the top header
...
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::AddSection( int teamType, int teamNumber )
{
    HFont hFallbackFont = scheme()->GetIScheme( GetScheme() )->GetFont( "DefaultVerySmallFallBack", false );
...
int CExperimentClientScoreBoardDialog::GetSectionFromTeamNumber( int teamNumber )
{
    switch ( teamNumber )
    {
        case TEAM_COMBINE:
...
//-----------------------------------------------------------------------------
bool CExperimentClientScoreBoardDialog::GetPlayerScoreInfo( int playerIndex, KeyValues *kv )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CExperimentClientScoreBoardDialog::UpdatePlayerInfo()
{
