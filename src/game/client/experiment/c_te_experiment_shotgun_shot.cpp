...
void C_TEExperimentFireBullets::CreateEffects( void )
{
...
void C_TEExperimentFireBullets::PostDataUpdate( DataUpdateType_t updateType )
{
...
IMPLEMENT_CLIENTCLASS_EVENT( C_TEExperimentFireBullets, DT_TEExperimentFireBullets, CTEExperimentFireBullets );

BEGIN_RECV_TABLE_NOBASE( C_TEExperimentFireBullets, DT_TEExperimentFireBullets )
