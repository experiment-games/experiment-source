...
void CAbuseReportDlg::UpdateSubmitButton()
{
    ...
    else
    {
        ...
        if (
            eContent >= 0 && GetAbuseType() >= 0 && pAccused != NULL )
        {
            bEnable = true;
