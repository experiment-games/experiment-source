...
{
    beams->CreateBeamFollow( m_iEntIndex, m_nModelIndex, m_nHaloIndex, 0, m_fLife, m_fWidth, m_fEndWidth, m_nFadeLength, r, g, b, a );
}
...
{
    beams->CreateBeamFollow( iEntIndex, modelIndex, haloIndex, 0, life, width, endWidth, fadeLength, r, g, b, a );
}
