...
class CYouTubeJob : public CJob
{
    ...
    virtual void OnHTTPRequestCompleted( HTTPRequestCompleted_t *pParam )
    {
        Assert( false );
    }
...
CYouTubeSystem::CYouTubeSystem()
    : m_eLoginStatus( kYouTubeLogin_NotLoggedIn ), m_pThreadPool( NULL ), m_mapUploads( DefLessFunc( YouTubeUploadHandle_t ) )
{
}
