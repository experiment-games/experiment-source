...
class CBasePlayer : public CBaseCombatCharacter
{
    ...
    float LastTimePlayerTalked() const
    {
    ...
    {
        return m_nMovementTicksForUserCmdProcessingRemaining;
    }
    ...
    const char *GetScriptOverlayMaterial() const
    {
        return m_Local.m_szScriptOverlayMaterial;
    }
