...
CVoteController::CVoteController()
    : m_mapVotesBySteamID( DefLessFunc( CSteamID ) )
{
}
...
CVoteController::~CVoteController()
{
    if ( g_voteControllerGlobal == this )
    {
        g_voteControllerGlobal = NULL;
    }
    else if ( g_voteControllerRed == this )
    {
        g_voteControllerRed = NULL;
    }
    else if ( g_voteControllerBlu == this )
    {
        g_voteControllerBlu = NULL;
    }
