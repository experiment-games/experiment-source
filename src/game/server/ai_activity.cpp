...
void CAI_BaseNPC::InitDefaultActivitySR( void )
{
    ...
    // Item3
    ADD_ACTIVITY_TO_SR( ACT_MP_STAND_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_RUN_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_WALK_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_ITEM3 );

    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_ITEM3_SECONDARY );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_ITEM3_SECONDARY );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_ITEM3 );

    ADD_ACTIVITY_TO_SR( ACT_MP_DEPLOYED_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_DEPLOYED_IDLE_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_DEPLOYED_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_DEPLOYED_IDLE_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED_ITEM3 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED_ITEM3 );

    // Item4
    ADD_ACTIVITY_TO_SR( ACT_MP_STAND_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_RUN_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_WALK_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_ITEM4 );

    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_ITEM4_SECONDARY );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_ITEM4_SECONDARY );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_ITEM4 );

    ADD_ACTIVITY_TO_SR( ACT_MP_DEPLOYED_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_DEPLOYED_IDLE_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_DEPLOYED_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_DEPLOYED_IDLE_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED_ITEM4 );
    ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED_ITEM4 );
    ...
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_DRAW );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_HOLSTER );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_IDLE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_PULLBACK );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_PRIMARYATTACK );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_SECONDARYATTACK );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_RELOAD );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_DRYFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_IDLE_TO_LOWERED );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_IDLE_LOWERED );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_LOWERED_TO_IDLE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_CHARGE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_IDLE_2 );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_IDLE_3 );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_CHARGE_IDLE_3 );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_HITCENTER );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_SWINGHARD );
    ...
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_STAND_PREFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_STAND_POSTFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_STAND_STARTFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_CROUCH_PREFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_CROUCH_POSTFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_SWIM_PREFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_ATTACK_SWIM_POSTFIRE );

    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_STAND_PREFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_STAND_POSTFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_STAND_STARTFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_CROUCH_PREFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_CROUCH_POSTFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_SWIM_PREFIRE );
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_ATTACK_SWIM_POSTFIRE );
    ...
    ADD_ACTIVITY_TO_SR( ACT_MELEE_VM_ITEM1_DRAW ),

    ADD_ACTIVITY_TO_SR( ACT_MP_FALLING_STOMP ),
    ADD_ACTIVITY_TO_SR( ACT_MP_FALLING_STOMP_PRIMARY ),
    ADD_ACTIVITY_TO_SR( ACT_MP_FALLING_STOMP_MELEE ),

    ADD_ACTIVITY_TO_SR( ACT_ITEM_DEPLOY ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM_UNDEPLOY ),

    // more inspect
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALLCLASS_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALLCLASS_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALLCLASS_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_SPECIAL_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_SPECIAL_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_SPECIAL_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_ITEM1_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM1_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM1_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_ITEM2_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM2_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM2_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_ITEM3_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM3_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_ITEM4_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_PRIMARY_ALT1_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_PRIMARY_ALT1_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_PRIMARY_ALT1_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_SECONDARY_ALT1_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_SECONDARY_ALT1_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_SECONDARY_ALT1_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT1_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT1_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT1_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT2_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT2_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT2_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT3_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT3_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_MELEE_ALT3_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_BUILDING_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_BUILDING_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_BUILDING_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_BREADMONSTER_VM_INSPECT_START ),
    ADD_ACTIVITY_TO_SR( ACT_BREADMONSTER_VM_INSPECT_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_BREADMONSTER_VM_INSPECT_END ),

    ADD_ACTIVITY_TO_SR( ACT_SLAP_VM_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_SLAP_VM_DRAW ),
    ADD_ACTIVITY_TO_SR( ACT_SLAP_VM ),

    ADD_ACTIVITY_TO_SR( ACT_MP_CYOA_PDA_INTRO ),
    ADD_ACTIVITY_TO_SR( ACT_MP_CYOA_PDA_IDLE ),
    ADD_ACTIVITY_TO_SR( ACT_MP_CYOA_PDA_OUTRO ),

    // Additional VM activities
    ...
    ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOYED_LIFTED_IN );
    ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOYED_LIFTED_OUT );
    ...
    ADD_ACTIVITY_TO_SR( ACT_VM_FIRE_TO_EMPTY );
    ADD_ACTIVITY_TO_SR( ACT_VM_FIREMODE );
    ADD_ACTIVITY_TO_SR( ACT_VM_HITKILL );
    ...
    ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_INSERT_EMPTY );
    ...
    ADD_ACTIVITY_TO_SR( ACT_VM_UNLOAD );

    ADD_ACTIVITY_TO_SR( ACT_CROSSBOW_HOLSTER_UNLOADED );

    ADD_ACTIVITY_TO_SR( ACT_DRIVE_AIRBOAT );
    ADD_ACTIVITY_TO_SR( ACT_DRIVE_JEEP );
    ADD_ACTIVITY_TO_SR( ACT_DRIVE_POD );

    ADD_ACTIVITY_TO_SR( ACT_FLINCH );
    ADD_ACTIVITY_TO_SR( ACT_FLINCH_BACK );
    ADD_ACTIVITY_TO_SR( ACT_FLINCH_SHOULDER_LEFT );
    ADD_ACTIVITY_TO_SR( ACT_FLINCH_SHOULDER_RIGHT );

    ADD_ACTIVITY_TO_SR( ACT_GMOD_DEATH );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_AGREE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_BECON );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_BOW );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_DISAGREE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_ITEM_DROP );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_ITEM_GIVE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_ITEM_PLACE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_ITEM_THROW );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_MELEE_SHOVE_1HAND );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_MELEE_SHOVE_2HAND );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_POINT );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_RANGE_FRENZY );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_RANGE_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_RANGE_ZOMBIE_SPECIAL );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_TAUNT_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_WAVE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_IN_CHAT );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_NOCLIP_LAYER );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_DUCK_01 );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_DUCK_02 );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_STAND_01 );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_STAND_02 );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_STAND_03 );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_STAND_04 );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SIT_ROLLERCOASTER );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_CHEER );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_DANCE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_LAUGH );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_MUSCLE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_PERSISTENCE );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_ROBOT );
    ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_SALUTE );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_FIST_BLOCK );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_ZOMBIE );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_COWER );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_ZOMBIE_01 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_ZOMBIE_02 );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_MELEE_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_ZOMBIE );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_ZOMBIE );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_CHARGING );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_FAST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_PANICKED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_PROTECTED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_ZOMBIE_FAST );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_AR2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_CROSSBOW );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_GRENADE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_MELEE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_PHYSGUN );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_PISTOL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_RPG );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_SHOTGUN );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_SLAM );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SIT_SMG1 );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_AR2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_CROSSBOW );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_GRENADE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_AR2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_CROSSBOW );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_GRENADE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_MELEE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_PASSIVE );
    ...
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_RPG );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SHOTGUN );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SLAM );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SMG1 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_MELEE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_PASSIVE );
    ...
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_RPG );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SHOTGUN );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SLAM );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SMG1 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_ZOMBIE );

    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_AR2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROSSBOW );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ANGRY );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_CAMERA );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_MELEE2 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_PASSIVE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_REVOLVER );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_SCARED );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_SUITCASE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ZOMBIE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ZOMBIE_01 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ZOMBIE_02 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ZOMBIE_03 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ZOMBIE_04 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_ZOMBIE_05 );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_DUEL );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_FIST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_GRENADE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_KNIFE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_MAGIC );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_MELEE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_MELEE2 );
    ...
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_SCARED );
    ...
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE );
    ...
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_ZOMBIE_SLUMP_ALT_IDLE );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_ZOMBIE_SLUMP_ALT_RISE_FAST );
    ADD_ACTIVITY_TO_SR( ACT_HL2MP_ZOMBIE_SLUMP_ALT_RISE_SLOW );
