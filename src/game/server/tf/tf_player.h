...
class CVoiceCommandBucketSizer
{
   public:
    ...
    {
        return tf_voice_command_suspension_rate_limit_bucket_count.GetInt();
    }
    float GetBucketRefillRate() const
    {
        return tf_voice_command_suspension_rate_limit_bucket_refill_rate.GetFloat();
    }
};
...
class CTFPlayer : public CBaseMultiplayerPlayer, public IHasAttributes, public IInventoryUpdateListener
{
   ...
   public:
    ...
    virtual int GetNumberofDominations( void )
    {
        return m_iNumberofDominations;
    }
    ...
    void SetHealthBuffTime( float flTime )
    {
        m_flHealthBuffTime = flTime;
    }
    ...
    void SetRememberLastWeapon( bool bRememberLastWeapon )
    {
        m_bRememberLastWeapon = bRememberLastWeapon;
    }
    void SetRememberActiveWeapon( bool bRememberActiveWeapon )
    {
        m_bRememberActiveWeapon = bRememberActiveWeapon;
    }

    void Regenerate( bool bRefillHealthAndAmmo = true );
    float GetNextRegenTime( void )
    {
        return m_flNextRegenerateTime;
    }
    void SetNextRegenTime( float flTime )
    {
        m_flNextRegenerateTime = flTime;
    }

    float GetNextChangeClassTime( void )
    {
        return m_flNextChangeClassTime;
    }
    void SetNextChangeClassTime( float flTime )
    {
        m_flNextChangeClassTime = flTime;
    }

    float GetNextChangeTeamTime( void )
    {
        return m_flNextChangeTeamTime;
    }
    void SetNextChangeTeamTime( float flTime )
    {
        m_flNextChangeTeamTime = flTime;
    }
    ...
    const CTFPlayerClass *GetPlayerClass( void ) const
    {
        return &m_PlayerClass;
    }
    int GetDesiredPlayerClassIndex( void )
    {
        return m_Shared.m_iDesiredPlayerClass;
    }
    void SetDesiredPlayerClassIndex( int iClass )
    {
        m_Shared.m_iDesiredPlayerClass = iClass;
    }
    ...
    void SetIsMiniBoss( bool isMiniBoss )
    {
        m_bIsMiniBoss = isMiniBoss;
    }
    ...
    CTFTeamSpawn *GetSpawnPoint( void )
    {
    ...
    void SetSeeCrit( bool bAllSeeCrit, bool bMiniCrit, bool bShowDisguisedCrit )
    {
        m_bAllSeeCrit = bAllSeeCrit;
        m_bMiniCrit = bMiniCrit;
        m_bShowDisguisedCrit = bShowDisguisedCrit;
    }
    void SetAttackBonusEffect( EAttackBonusEffects_t effect )
    {
        m_eBonusAttackEffect = effect;
    }
    EAttackBonusEffects_t GetAttackBonusEffect( void )
    {
        return m_eBonusAttackEffect;
    }
    ...
    void SetGibbedOnLastDeath( bool bGibbed )
    {
        m_bGibbedOnLastDeath = bGibbed;
    }
    bool WasGibbedOnLastDeath( void )
    {
        return m_bGibbedOnLastDeath;
    }
    ...
    float GetLastDamageReceivedTime( void )
    {
        return m_flLastDamageTime;
    }
    float GetLastEntityDamagedTime( void )
    {
        return m_flLastDamageDoneTime;
    }
    void SetLastEntityDamagedTime( float flTime )
    {
        m_flLastDamageDoneTime = flTime;
    }
    CBaseEntity *GetLastEntityDamaged( void )
    {
        return m_hLastDamageDoneEntity;
    }
    void SetLastEntityDamaged( CBaseEntity *pEnt )
    {
        m_hLastDamageDoneEntity = pEnt;
    }
    ...
    {
        return m_Shared.GetCritMult();
    }
    void RecordDamageEvent( const CTakeDamageInfo &info, bool bKill, int nVictimPrevHealth )
    {
        m_Shared.RecordDamageEvent( info, bKill, nVictimPrevHealth );
    }

    bool GetHudClassAutoKill( void )
    {
        return m_bHudClassAutoKill;
    }
    void SetHudClassAutoKill( bool bAutoKill )
    {
        m_bHudClassAutoKill = bAutoKill;
    }

    bool GetMedigunAutoHeal( void )
    {
        return m_bMedigunAutoHeal;
    }
    void SetMedigunAutoHeal( bool bMedigunAutoHeal )
    {
        m_bMedigunAutoHeal = bMedigunAutoHeal;
    }
    CBaseEntity *MedicGetHealTarget( void );
    HSCRIPT ScriptGetHealTarget()
    {
        return ToHScript( MedicGetHealTarget() );
    }
    ...
    {
        return m_bAutoRezoom;
    }
    void SetAutoRezoom( bool bAutoRezoom )
    {
        m_bAutoRezoom = bAutoRezoom;
    }
    bool ShouldAutoReload( void )
    {
        return m_bAutoReload;
    }
    void SetAutoReload( bool bAutoReload )
    {
    ...
    // [msmith]	Added a player type so we can distinguish between bots and humans.
    //=============================================================================
    inline TFPlayerType GetPlayerType()
    {
        return m_playerType;
    }
    inline void SetPlayerType( TFPlayerType playerType )
    {
    ...
    {
        return ( !( GetFlags() & FL_ONGROUND ) && ( GetWaterLevel() == WL_NotInWater ) && ( ( m_iBlastJumpState != 0 ) ) || m_Shared.InCond( TF_COND_ROCKETPACK ) );
    }
    ...
    {
        return m_bIsCoaching;
    }
    void SetIsCoaching( bool bIsCoaching );

    void SetCoach( CTFPlayer *pCoach )
    {
        m_hCoach = pCoach;
    }
    CTFPlayer *GetCoach() const
    {
        return m_hCoach;
    }

    void SetStudent( CTFPlayer *pStudent )
    {
        m_hStudent = pStudent;
    }
    CTFPlayer *GetStudent() const
    {
        return m_hStudent;
    }
    ...
    void SetUseBossHealthBar( bool bUseBossHealthBar )
    {
        m_bUseBossHealthBar = bUseBossHealthBar;
    }

    void SetUsingVRHeadset( bool bState )
    {
        m_bUsingVRHeadset = bState;
    }
    ...
    CAttributeContainer *GetAttributeContainer( void )
    {
        return NULL;
    }
    CBaseEntity *GetAttributeOwner( void )
    {
        return NULL;
    }
   ...
   public:
    ...
    {
        m_Shared.SetLoadoutUnavailable( true );
    }

    // Inventory access
    CTFPlayerInventory *Inventory( void )
    {
        return &m_Inventory;
    }
   ...
   public:
    ...
    CTFWeaponBase *GetOffHandWeapon( void )
    {
        return m_hOffHandWeapon;
    }
   ...
   public:
    ...
    CTFPlayer *GetTauntPartner( void )
    {
        return m_hHighFivePartner;
    }
    float GetTauntYaw( void )
    {
        return m_flTauntYaw;
    }
    float GetPrevTauntYaw( void )
    {
        return m_flPrevTauntYaw;
    }
    ...
    bool IsTauntInitiator() const
    {
        return m_bIsTauntInitiator;
    }
    bool IsTauntForceMovingForward() const
    {
        return m_bTauntForceMoveForward;
    }
    float GetTauntMoveAcceleration() const
    {
        return m_flTauntMoveAccelerationTime;
    }
    float GetTauntMoveSpeed() const
    {
        return m_flTauntForceMoveForwardSpeed;
    }
    float GetTauntTurnAccelerationTime() const
    {
        return m_flTauntTurnAccelerationTime;
    }
    virtual int GetAllowedTauntPartnerTeam() const;
    CEconItemView *GetTauntEconItemView()
    {
        return m_TauntEconItemView.IsValid() ? &m_TauntEconItemView : NULL;
    }
    ...
    void ScriptTaunt( int iTauntIndex, int iTauntConcept )
    {
        Taunt( ( taunts_t )iTauntIndex, iTauntConcept );
    }
    bool IsTaunting( void ) const
    {
        return m_Shared.InCond( TF_COND_TAUNTING );
    }
    ...
    void EndLongTaunt();
    float GetTauntRemoveTime( void ) const
    {
        return m_flTauntRemoveTime;
    }
    bool IsAllowedToRemoveTaunt() const
    {
        return m_bAllowedToRemoveTaunt;
    }
    ...
    float GetTauntAttackTime() const
    {
        return m_flTauntAttackTime;
    }

    void SetRPSResult( int iRPSResult )
    {
        m_iTauntRPSResult = iRPSResult;
    }

    void HandleWeaponSlotAfterTaunt();

    float GetCurrentTauntMoveSpeed() const
    {
        return m_flCurrentTauntMoveSpeed;
    }
    void SetCurrentTauntMoveSpeed( float flSpeed )
    {
        m_flCurrentTauntMoveSpeed = flSpeed;
    }

    float GetVehicleReverseTime() const
    {
        return m_flVehicleReverseTime;
    }
    void SetVehicleReverseTime( float flTime )
    {
        m_flVehicleReverseTime = flTime;
    }

    bool IsViewingCYOAPDA( void ) const
    {
        return m_bViewingCYOAPDA;
    }
    bool IsRegenerating( void ) const
    {
        return m_bRegenerating;
    }

    HSCRIPT ScriptGetActiveWeapon( void )
    {
        return ToHScript( GetActiveTFWeapon() );
    }
    ...
    {
        return m_Shared.IsCarryingRune();
    }
    bool ScriptIsCritBoosted( void ) const
    {
        return m_Shared.IsCritBoosted();
    }
    bool ScriptIsInvulnerable( void ) const
    {
        return m_Shared.IsInvulnerable();
    }
    bool ScriptIsStealthed( void ) const
    {
        return m_Shared.IsStealthed();
    }
    bool ScriptCanBeDebuffed( void ) const
    {
        return m_Shared.CanBeDebuffed();
    }
    bool ScriptIsImmuneToPushback( void ) const
    {
    ...
    void ScriptSetDisguiseAmmoCount( int nValue )
    {
        return m_Shared.SetDisguiseAmmoCount( nValue );
    }
    ...
    {
        return m_Shared.IsFullyInvisible();
    }
    float ScriptGetSpyCloakMeter()
    {
        return m_Shared.GetSpyCloakMeter();
    }
    void ScriptSetSpyCloakMeter( float flValue )
    {
        return m_Shared.SetSpyCloakMeter( flValue );
    }
    bool ScriptIsRageDraining()
    {
        return m_Shared.IsRageDraining();
    }
    float ScriptGetRageMeter()
    {
        return m_Shared.GetRageMeter();
    }
    void ScriptSetRageMeter( float flValue )
    {
        return m_Shared.SetRageMeter( flValue );
    }
    float ScriptGetScoutHypeMeter()
    {
        return m_Shared.GetScoutHypeMeter();
    }
    void ScriptSetScoutHypeMeter( float flValue )
    {
        return m_Shared.SetScoutHypeMeter( flValue );
    }
    bool ScriptIsHypeBuffed()
    {
        return m_Shared.IsHypeBuffed();
    }
    ...
    int ScriptGetCaptures() const
    {
        return m_Shared.GetCaptures( 0 );
    }
    int ScriptGetDefenses() const
    {
        return m_Shared.GetDefenses( 0 );
    }
    int ScriptGetDominations() const
    {
        return m_Shared.GetDominations( 0 );
    }
    int ScriptGetRevenge() const
    {
        return m_Shared.GetRevenge( 0 );
    }
    int ScriptGetBuildingsDestroyed() const
    {
        return m_Shared.GetBuildingsDestroyed( 0 );
    }
    int ScriptGetHeadshots() const
    {
        return m_Shared.GetHeadshots( 0 );
    }
    int ScriptGetBackstabs() const
    {
        return m_Shared.GetBackstabs( 0 );
    }
    int ScriptGetHealPoints() const
    {
        return m_Shared.GetHealPoints( 0 );
    }
    int ScriptGetInvulns() const
    {
        return m_Shared.GetInvulns( 0 );
    }
    int ScriptGetTeleports() const
    {
        return m_Shared.GetTeleports( 0 );
    }
    int ScriptGetResupplyPoints() const
    {
        return m_Shared.GetResupplyPoints( 0 );
    }
    int ScriptGetKillAssists() const
    {
        return m_Shared.GetKillAssists( 0 );
    }
    int ScriptGetBonusPoints() const
    {
        return m_Shared.GetBonusPoints( 0 );
    }
    ...
    {
        return m_Shared.IsParachuteEquipped();
    }
    ...
    bool ScriptIsFakeClient() const
    {
        return this->IsFakeClient();
    }
    int ScriptGetBotType() const
    {
        return this->GetBotType();
    }
    bool ScriptIsBotOfType( int nType ) const
    {
        return this->IsBotOfType( nType );
    }
   ...
   public:
    ...
    void SetDeathFlags( int iDeathFlags )
    {
        m_iDeathFlags = iDeathFlags;
    }
    int GetDeathFlags()
    {
        return m_iDeathFlags;
    }
    void SetMaxSentryKills( int iMaxSentryKills )
    {
        m_iMaxSentryKills = iMaxSentryKills;
    }
    int GetMaxSentryKills()
    {
        return m_iMaxSentryKills;
    }

    CNetworkVar( bool, m_iSpawnCounter );

    void CheckForIdle( void );
    inline bool IsAwayFromKeyboard( void )
    {
        return m_bIsAFK;
    }
    ...
    void StopRandomExpressions( void )
    {
        m_flNextRandomExpressionTime = -1;
    }
    void StartRandomExpressions( void )
    {
    ...
    void ClearPunchVictims( void )
    {
        m_aPunchVictims.RemoveAll();
    }
    void ClearBurnFromBehindAttackers( void )
    {
        m_aBurnFromBackAttackers.RemoveAll();
    }

    int RocketJumped( void )
    {
        return m_iBlastJumpState & TF_PLAYER_ROCKET_JUMPED;
    }
    int StickyJumped( void )
    {
        return m_iBlastJumpState & TF_PLAYER_STICKY_JUMPED;
    }
    void SetBlastJumpState( int iState, bool bPlaySound = false );
    void ClearBlastJumpState( void );

    int GetPreviousTeam( void )
    {
        return m_iPreviousteam;
    }
    bool IsArenaSpectator( void )
    {
        return m_bArenaSpectator;
    }

    float GetTeamJoinTime( void )
    {
        return m_flTeamJoinTime;
    }
    void MarkTeamJoinTime( void )
    {
        m_flTeamJoinTime = gpGlobals->curtime;
    }
    void PlayerJustPlayed( bool bPlayed )
    {
        m_bJustPlayed = bPlayed;
    }
    bool DidPlayerJustPlay( void )
    {
        return m_bJustPlayed;
    }
    ...
    void SetTargetDummy( void )
    {
        m_bIsTargetDummy = true;
    }

    bool ShouldCollideWithSentry( void )
    {
        return m_bCollideWithSentry;
    }
    ...
    int GetHealthBefore( void )
    {
        return m_iHealthBefore;
    }
    ...
    int GetTeamChangeCount( void )
    {
        return m_iTeamChanges;
    }
    int GetClassChangeCount( void )
    {
        return m_iClassChanges;
    }

    void IncrementKillCountSinceLastDeploy( const CTakeDamageInfo &info );

    void ForceItemRemovalOnRespawn( void )
    {
   ...
   public:
    ...
    bool IsMissionEnemy( void )
    {
        return m_bIsMissionEnemy;
    }
    void MarkAsMissionEnemy( void )
    {
        m_bIsMissionEnemy = true;
    }
    bool IsSupportEnemy( void )
    {
        return m_bIsSupportEnemy;
    }
    void MarkAsSupportEnemy( void )
    {
        m_bIsSupportEnemy = true;
    }
    void MarkAsLimitedSupportEnemy( void )
    {
        m_bIsLimitedSupportEnemy = true;
    }
    ...
    void SetCustomCurrencyWorth( int nAmount )
    {
        m_nCurrency = nAmount;
    }
    ...
    {
        return m_nExperienceLevel;
    }
    void SetExperienceLevel( int nValue )
    {
        m_nExperienceLevel.Set( MAX( nValue, 1 ) );
    }
    int GetExperiencePoints( void )
    {
        return m_nExperiencePoints;
    }
    void SetExperiencePoints( int nValue )
    {
        m_nExperiencePoints = MAX( nValue, 0 );
    }
    ...
    CUtlVector< CUpgradeInfo > *GetRefundableUpgrades( void )
    {
        return &m_RefundableUpgrades;
    }
    void ResetRefundableUpgrades( void )
    {
        m_RefundableUpgrades.RemoveAll();
    }
    void BeginPurchasableUpgrades( void );
    void EndPurchasableUpgrades( void );
    bool CanPurchaseUpgrades( void ) const
    {
        Assert( m_nCanPurchaseUpgradesCount >= 0 );
        return m_nCanPurchaseUpgradesCount > 0;
    }
    ...
    void SetWaterExitTime( float flTime )
    {
        m_flWaterExitTime = flTime;
    }
    float GetWaterExitTime( void )
    {
        return m_flWaterExitTime;
    }
    ...
    float GetTimeSinceLastThink( void ) const
    {
        return ( m_flLastThinkTime >= 0.f ) ? gpGlobals->curtime - m_flLastThinkTime : -1.f;
    }
    float GetRespawnTimeOverride( void ) const
    {
        return m_flRespawnTimeOverride;
    }
    const char *GetRespawnLocationOverride( void ) const
    {
        return ( m_strRespawnLocationOverride == NULL_STRING ) ? NULL : m_strRespawnLocationOverride.ToCStr();
    }
    void SetRespawnOverride( float flRespawnTime, string_t respawnLocation )
    {
        m_flRespawnTimeOverride = flRespawnTime;
        m_strRespawnLocationOverride = respawnLocation;
    }
    void ResetIdleCheck( void )
    {
        m_flLastAction = gpGlobals->curtime;
    }

    // Matchmaking
    void SetMatchSafeToLeave( bool bMatchSafeToLeave )
    {
        m_bMatchSafeToLeave = bMatchSafeToLeave;
    }

    void SetPrevRoundTeamNum( int nTeamNum )
    {
        m_nPrevRoundTeamNum = nTeamNum;
    }
    int GetPrevRoundTeamNum( void )
    {
        return m_nPrevRoundTeamNum;
    }
   ...
   public:
    ...
    void SetDeployingBombState( BombDeployingState_t nDeployingBombState )
    {
        m_nDeployingBombState = nDeployingBombState;
    }
    BombDeployingState_t GetDeployingBombState( void ) const
    {
        return m_nDeployingBombState;
    }

    void SetPendingMerasmusPlayerBombExplode( void )
    {
   ...
   public:
    ...
    {
        return m_iKartHealth;
    }
    void AddKartDamage( int iDamage )
    {
        m_iKartHealth = Max( 0, m_iKartHealth + iDamage );
    }
    float GetKartKnockbackMultiplier( float flExtraMultiplier ) const;

    void ResetKartDamage();
    CBaseEntity *GetKartBombHeadTarget() const
    {
        return m_hKartBombHeadTarget;
    }
    void SetKartBombHeadTarget( CBaseEntity *pEnt )
    {
        m_hKartBombHeadTarget = pEnt;
    }
    ...
    QAngle GetAnimRenderAngles( void )
    {
   ...
   public:
    ...
    HSCRIPT ScriptGetGrapplingHookTarget() const
    {
        return ToHScript( m_hGrapplingHookTarget.Get() );
    }
    void ScriptSetGrapplingHookTarget( HSCRIPT pTarget, bool bShouldBleed )
    {
        return SetGrapplingHookTarget( ToEnt( pTarget ), bShouldBleed );
    }

    void AddHudHideFlags( int flags )
    {
        m_Local.m_iHideHUD |= flags;
    }
    ...
    int GetHudHideFlags()
    {
        return m_Local.m_iHideHUD;
    }

    bool IsUsingActionSlot() const
    {
        return m_bUsingActionSlot;
    }

    void SetSecondaryLastWeapon( CBaseCombatWeapon *pSecondaryLastWeapon )
    {
        m_hSecondaryLastWeapon = pSecondaryLastWeapon;
    }
    CBaseCombatWeapon *GetSecondaryLastWeapon() const
    {
        return m_hSecondaryLastWeapon;
    }
    ...
    void SetCampaignMedalActive( int iMedal )
    {
        m_iCampaignMedals |= iMedal;
    }
    ...
    void SetNextScorePointForPD( float flTime )
    {
        m_flNextScorePointForPD = flTime;
    }
    ...
    int GetSkinOverride() const
    {
        return m_iPlayerSkinOverride;
    }

    bool ShouldGetBonusPointsForExtinguishEvent( int userID );

    void SetLastAutobalanceTime( float flTime )
    {
        m_flLastAutobalanceTime = flTime;
    }
    float GetLastAutobalanceTime()
    {
        return m_flLastAutobalanceTime;
    }
    bool IsMaxHealthDraining( void )
    {
...
class CObserverPoint : public CPointEntity
{
   ...
   public:
    ...
    bool IsDefaultWelcome( void )
    {
        return m_bDefaultWelcome;
    }
    bool IsMatchSummary( void )
    {
        return m_bMatchSummary;
    }
