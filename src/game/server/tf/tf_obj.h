...
class CBaseObject : public CBaseCombatCharacter, public IHasBuildPoints, public IScorer, public IBaseObjectAutoList
{
   ...
   public:
    ...
    {
        return m_fObjectFlags;
    }
    void SetObjectFlags( int flags )
    {
        m_fObjectFlags = flags;
    }
    ...
    bool CannotDie() const
    {
        return m_bCannotDie;
    }
    void SetCannotDie( bool bCannotDie )
    {
        m_bCannotDie = bCannotDie;
    }
    ...
    virtual int GetUpgradeLevel( void ) const
    {
        return m_iUpgradeLevel;
    }
    int GetUpgradeMetal( void ) const
    {
        return m_iUpgradeMetal;
    }
    int GetHighestUpgradeLevel( void )
    {
        return Min( ( int )m_iHighestUpgradeLevel, GetMaxUpgradeLevel() );
    }
    void SetHighestUpgradeLevel( int nLevel )
    {
        m_iHighestUpgradeLevel = Min( nLevel, GetMaxUpgradeLevel() );
    }
    ...
    void ForceQuickBuild()
    {
        m_bForceQuickBuild = true;
    }
    ...
    bool IsUsingReverseBuild( void )
    {
        return ( GetReversesBuildingConstructionSpeed() != 0.0f );
    }
    ...
    bool IsBuiltOnAttachment( void )
    {
        return ( m_hBuiltOnEntity.Get() != NULL );
    }
    CBaseEntity *GetBuiltOnObject( void )
    {
        return m_hBuiltOnEntity.Get();
    }
    ...
    int GetObjectMode( void ) const
    {
        return m_iObjectMode;
    }

    float GetConstructionStartTime( void )
    {
        return m_flConstructionStartTime;
    }
    ...
    bool IsMiniBuilding( void ) const
    {
        return m_bMiniBuilding;
    }
    bool IsDisposableBuilding( void ) const
    {
        return m_bDisposableBuilding;
    }
    ...
    {
        return !IsDisposableBuilding();
    }

    Vector GetBuildOrigin()
    {
        return m_vecBuildOrigin;
    }
    Vector GetBuildCenterOfMass()
    {
