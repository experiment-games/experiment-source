...
class CTFTeamSpawn : public CServerOnlyPointEntity, public ITFTeamSpawnAutoList
{
    ...
    PlayerTeamSpawnMode_t GetTeamSpawnMode( void )
    {
        return m_nSpawnMode;
    }
    ...
    {
        return m_hControlPoint;
    }
    CHandle< CTeamControlPointRound > GetRoundBlueSpawn( void )
    {
        return m_hRoundBlueSpawn;
    }
    CHandle< CTeamControlPointRound > GetRoundRedSpawn( void )
    {
        return m_hRoundRedSpawn;
    }

    PlayerTeamSpawn_MatchSummary_t GetMatchSummaryType( void )
    {
        return m_nMatchSummaryType;
    }
    bool AlreadyUsedForMatchSummary( void )
    {
        return m_bAlreadyUsedForMatchSummary;
    }
    void SetAlreadyUsedForMatchSummary( void )
    {
