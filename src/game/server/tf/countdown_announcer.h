...
class CCountdownAnnouncer
{
    ...
    CCountdownAnnouncer( const TimeSounds *pTimeSounds )
        : m_state( Disabled ), m_pTimeSounds( pTimeSounds ), m_fTimeRemain( 0 ), m_iPrevSecondsRemain( 0 )
    {
    }
    ...
    bool Tick( float delta )
    {
        ...
        switch ( m_state )
        {
            ...
            case Running:
            {
                ...
                {
                    case 60:
                        BroadcastSound( m_pTimeSounds->at60 );
                        break;
                    case 30:
                        BroadcastSound( m_pTimeSounds->at30 );
                        break;
                    case 10:
                        BroadcastSound( m_pTimeSounds->at10 );
                        break;
                    case 5:
                        BroadcastSound( m_pTimeSounds->at5 );
                        break;
                    case 4:
                        BroadcastSound( m_pTimeSounds->at4 );
                        break;
                    case 3:
                        BroadcastSound( m_pTimeSounds->at3 );
                        break;
                    case 2:
                        BroadcastSound( m_pTimeSounds->at2 );
                        break;
                    case 1:
                        BroadcastSound( m_pTimeSounds->at1 );
                        break;
                    default:
                        break;
                }
