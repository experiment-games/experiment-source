...
class CObjectTeleporter : public CBaseObject, public CGameEventListener
{
   ...
   public:
    ...
    {
        return m_iState;
    }  // state of the object ( building, charging, ready etc )
    ...
    void SetTeleporterType( int iVal )
    {
        m_iTeleportType = iVal;
    }
    int GetTeleporterType( void )
    {
        return m_iTeleportType;
    }
    bool IsEntrance( void )
    {
        return m_iTeleportType == TTYPE_ENTRANCE;
    }
    bool IsExit( void )
    {
        return m_iTeleportType == TTYPE_EXIT;
    }
    ...
    CTFPlayer *GetTeleportingPlayer( void )
    {
