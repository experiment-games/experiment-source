...
class CBossAlpha : public NextBotCombatCharacter
{
    ...
    // INextBot
    virtual CBossAlphaIntention *GetIntentionInterface( void ) const
    {
        return m_intention;
    }
    virtual CBossAlphaLocomotion *GetLocomotionInterface( void ) const
    {
        return m_locomotor;
    }
    ...
    virtual CBossAlphaVision *GetVisionInterface( void ) const
    {
        return m_vision;
    }
    ...
    virtual bool IsMiniBoss( void ) const
    {
        return false;
    }
    ...
    virtual int GetRocketLaunchCount( void ) const
    {
        return 5;
    }
    virtual float GetRocketDamage( void ) const
    {
        return 25.0f;
    }
    virtual float GetRocketAimError( void ) const
    {
        return 1.81f;
    }
    virtual float GetRocketInterval( void ) const
    {
        return 0.3f;
    }
    virtual const char *GetRocketSoundEffect( void ) const
    {
        return "Weapon_RPG.Single";
    }

    virtual float GetGrenadeInterval( void ) const
    {
        return 10.0f;
    }

    virtual float GetBecomeStunnedDamage( void ) const
    {
        return 500.0f;
    }
