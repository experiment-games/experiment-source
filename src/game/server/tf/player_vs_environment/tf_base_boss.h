...
class CTFBaseBossLocomotion : public NextBotGroundLocomotion
{
   public:
    ...
    {
        m_flStepHeight = m_flMaxJumpHeight = 100.0f;
    }
    ...
    {
        return m_flMaxJumpHeight;
    }  // return maximum height of a jump

    virtual void FaceTowards( const Vector &target );  // rotate body to face towards "target"

    void SetStepHeight( float flStepHeight )
    {
        m_flStepHeight = flStepHeight;
    }
    void SetMaxJumpHeight( float flMaxJumpHeight )
    {
