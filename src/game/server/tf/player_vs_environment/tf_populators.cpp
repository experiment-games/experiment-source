...
// CMissionPopulator
//-----------------------------------------------------------------------
CMissionPopulator::CMissionPopulator( CPopulationManager *manager )
    : IPopulator( manager )
{
...
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
CRandomPlacementPopulator::CRandomPlacementPopulator( CPopulationManager *manager )
    : IPopulator( manager )
{
    m_count = 0;
...
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
CPeriodicSpawnPopulator::CPeriodicSpawnPopulator( CPopulationManager *manager )
    : IPopulator( manager )
{
    m_minInterval = 30.0f;
    m_maxInterval = 30.0f;
...
CWaveSpawnPopulator::CWaveSpawnPopulator( CPopulationManager *manager )
    : IPopulator( manager )
{
    m_totalCount = 0;
    m_maxActive = 999;
...
// CWave
//-------------------------------------------------------------------------
CWave::CWave( CPopulationManager *manager )
    : IPopulator( manager )
{
    m_iEnemyCount = 0;
    m_nTanksSpawned = 0;
