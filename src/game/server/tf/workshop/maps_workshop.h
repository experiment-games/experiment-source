...
class CTFWorkshopMap
{
    ...
    {
        return m_strCanonicalName.Length() ? m_strCanonicalName.Get() : NULL;
    }

    bool GetLocalFile( /* out */ CUtlString &strLocalFile );

    PublishedFileId_t FileID() const
    {
        return m_nFileID;
    }
