...
class CAchievementData
{
   public:
    ...
    EntityHistory_t *GetDamagerHistory( int i )
    {
        if ( i >= aDamagers.Count() ) return NULL;
        return &aDamagers[i];
    }
    ...
    EntityDamageHistory_t *GetDamageEventHistory( int i )
    {
        if ( i >= aDamageEvents.Count() ) return NULL;
        return &aDamageEvents[i];
    }
    int GetDamageEventHistoryCount( void )
    {
        return aDamageEvents.Count();
    }
    ...
    EntityHistory_t *GetTargetHistory( int i )
    {
        if ( i >= aTargets.Count() ) return NULL;
        return &aTargets[i];
    }
