...
//---------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------
CNextBotFlyingLocomotion::CNextBotFlyingLocomotion( INextBot *bot )
    : ILocomotion( bot )
{
    Reset();
}
...
void CNextBotFlyingLocomotion::MaintainAltitude( void )
{
    ...
    // find ceiling
    TraceHull( me->GetAbsOrigin(), me->GetAbsOrigin() + Vector( 0, 0, 1000.0f ), me->WorldAlignMins(), me->WorldAlignMaxs(), GetBot()->GetBodyInterface()->GetSolidMask(), &filter, &result );
