...
class CBotNPC : public NextBotCombatCharacter
{
    ...
    // INextBot
    virtual CBotNPCIntention *GetIntentionInterface( void ) const
    {
        return m_intention;
    }
    virtual CBotNPCLocomotion *GetLocomotionInterface( void ) const
    {
        return m_locomotor;
    }
    ...
    virtual CBotNPCVision *GetVisionInterface( void ) const
    {
        return m_vision;
    }
