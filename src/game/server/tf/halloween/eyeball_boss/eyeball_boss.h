...
class CEyeballBoss : public CHalloweenBaseBoss, public IEyeballBossAutoList
{
    ...
    virtual CEyeballBossLocomotion *GetLocomotionInterface( void ) const
    {
        return m_locomotor;
    }
    virtual CEyeballBossBody *GetBodyInterface( void ) const
    {
        return m_body;
    }
    virtual CDisableVision *GetVisionInterface( void ) const
    {
        return m_vision;
    }
