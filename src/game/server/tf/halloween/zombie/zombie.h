...
class CZombie : public NextBotCombatCharacter, public IZombieAutoList
{
   public:
    ...
    // INextBot
    virtual CZombieIntention *GetIntentionInterface( void ) const
    {
        return m_intention;
    }
    virtual CZombieLocomotion *GetLocomotionInterface( void ) const
    {
        return m_locomotor;
    }
    ...
    void StartLifeTimer( float flLifeTime )
    {
    ...
    SkeletonType_t GetSkeletonType() const
    {
        return m_nType;
    }
    ...
    {
        return m_flAttackRange;
    }
    float GetAttackDamage() const
    {
        return m_flAttackDamage;
    }
