...
class CTFProjectile_Arrow : public CTFBaseRocket, public IScorer
{
   public:
    ...
    {
        return ( GetMoveType() != MOVETYPE_NONE );
    }
    void SetPenetrate( bool bPenetrate = false )
    {
...
class CTFProjectile_GrapplingHook : public CTFProjectile_Arrow
{
   public:
    ...
    virtual bool IsBreakable( void ) const OVERRIDE
    {
        return false;
    }
    ...
    virtual bool CanCollideWithTeammates() const OVERRIDE
    {
        return false;
    }
