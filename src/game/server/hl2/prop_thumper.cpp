...
void CPropThumper::Thump( void )
{
    ...
    {
        NDebugOverlay::Box( GetAbsOrigin(), Vector( -THUMPER_RADIUS, -THUMPER_RADIUS, -THUMPER_RADIUS ), Vector( THUMPER_RADIUS, THUMPER_RADIUS, THUMPER_RADIUS ), 255, 64, 64, 255, THUMPER_SOUND_DURATION );
    }
