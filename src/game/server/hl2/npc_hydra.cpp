...
void CNPC_Hydra::MoveBody()
{
    ...
    for ( i = iFirst; i <= iLast; i++ )
    {
        ...
        AI_TraceHull( m_body[i].vecPos, m_body[i].vecPos + m_body[i].vecDelta, Vector( -2, -2, -2 ), Vector( 2, 2, 2 ), MASK_NPCSOLID, this, COLLISION_GROUP_NONE, &tr );
        ...
        if ( tr.fraction != 1.0 )
        {
            ...
            AI_TraceHull( direct, direct + slide * ( 1 - tr.fraction ), Vector( -2, -2, -2 ), Vector( 2, 2, 2 ), MASK_NPCSOLID, this, COLLISION_GROUP_NONE, &tr );
        ...
        AI_TraceHull( direct, m_body[i - 1].vecPos, Vector( -2, -2, -2 ), Vector( 2, 2, 2 ), MASK_NPCSOLID, this, COLLISION_GROUP_NONE, &tr );
...
bool CNPC_Hydra::IsValidConnection( int iNode0, int iNode1 )
{
    ...
    AI_TraceHull( m_body[iNode0].vecPos, m_body[iNode1].vecPos, Vector( -2, -2, -2 ), Vector( 2, 2, 2 ), MASK_NPCSOLID, this, COLLISION_GROUP_NONE, &tr );
