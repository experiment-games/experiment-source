...
class INextBot : public INextBotEventResponder
{
   public:
    ...
    virtual class NextBotCombatCharacter *GetNextBotCombatCharacter( void ) const
    {
        return NULL;
    }

#ifdef TERROR
    virtual class SurvivorBot *MySurvivorBotPointer() const
    {
        return NULL;
    }
#endif
    ...
    HSCRIPT ScriptGetLocomotionInterface( void ) const
    {
        return ToHScript( this->GetLocomotionInterface() );
    }
    HSCRIPT ScriptGetIntentionInterface( void ) const
    {
        return ToHScript( this->GetIntentionInterface() );
    }
    HSCRIPT ScriptGetBodyInterface( void ) const
    {
        return ToHScript( this->GetBodyInterface() );
    }
    HSCRIPT ScriptGetVisionInterface( void ) const
    {
        return ToHScript( this->GetVisionInterface() );
    }
    ...
    bool ScriptIsEnemy( HSCRIPT hThem ) const
    {
        return this->IsEnemy( ToEnt( hThem ) );
    }
    bool ScriptIsFriend( HSCRIPT hThem ) const
    {
        return this->IsFriend( ToEnt( hThem ) );
    }
    bool ScriptIsSelf( HSCRIPT hThem ) const
    {
        return this->IsSelf( ToEnt( hThem ) );
    }
