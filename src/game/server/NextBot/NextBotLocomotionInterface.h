...
class ILocomotion : public INextBotComponent
{
    ...
    //
    virtual bool ClimbUpToLedge( const Vector &landingGoal, const Vector &landingForward, const CBaseEntity *obstacle )
    {
        return true;
    ...
    virtual float GetSpeedLimit( void ) const
    {
        return 1000.0f;
    ...
    {
        this->OnLeaveGround( ToEnt( hGround ) );
    }
