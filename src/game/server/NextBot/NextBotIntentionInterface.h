...
#define IMPLEMENT_INTENTION_INTERFACE( Actor, InitialAction )                          \
    Actor::Actor##Intention::Actor##Intention( Actor *me ) : IIntention( me )          \
    {                                                                                  \
        m_behavior = new Behavior< Actor >( new InitialAction );                       \
    }                                                                                  \
    Actor::Actor##Intention::~Actor##Intention()                                       \
    {                                                                                  \
        delete m_behavior;                                                             \
    }                                                                                  \
    void Actor::Actor##Intention::Reset( void )                                        \
    {                                                                                  \
        delete m_behavior;                                                             \
        m_behavior = new Behavior< Actor >( new InitialAction );                       \
    }                                                                                  \
    void Actor::Actor##Intention::Update( void )                                       \
    {                                                                                  \
        m_behavior->Update( static_cast< Actor * >( GetBot() ), GetUpdateInterval() ); \
    }

//
// Use this macro in the constructor of your bot to allocate the IIntention-derived class
//
#define ALLOCATE_INTENTION_INTERFACE( Actor )       \
    {                                               \
        m_intention = new Actor##Intention( this ); \
    }

//
// Use this macro in the destructor of your bot to deallocate the IIntention-derived class
//
#define DEALLOCATE_INTENTION_INTERFACE         \
    {                                          \
        if ( m_intention ) delete m_intention; \
    }
