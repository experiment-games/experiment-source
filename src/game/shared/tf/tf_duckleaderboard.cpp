...
CDucksLeaderboard::CDucksLeaderboard( Panel *parent, const char *panelName, const char *pszDuckLeaderboardname )
    : CTFLeaderboardPanel( parent, panelName ), m_pszDuckLeaderboardName( pszDuckLeaderboardname ), m_pToolTip( NULL )
{
...
CDucksLeaderboardManager::CDucksLeaderboardManager( Panel *parent, const char *panelName )
    : EditablePanel( parent, panelName ), m_nCurrentPage( 0 ), m_flFadeStartTime( Plat_FloatTime() ), m_pDimmer( NULL )
{
