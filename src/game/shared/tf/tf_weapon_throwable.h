...
class CTFThrowable : public CTFJar, public ITFChargeUpWeapon
{
   public:
    ...
    virtual bool ShowHudElement( void )
    {
        return true;
    }
...
class CTFProjectile_Throwable : public CTFProjectile_Jar
{
   public:
    ...
    virtual int GetWeaponID( void ) const
    {
        return TF_WEAPON_GRENADE_THROWABLE;
    }
    ...
    {
        return TF_DMG_CUSTOM_THROWABLE;
    }
    ...
    virtual float GetProjectileMaxSpeed()
    {
        return 2500.0f;
    }
    virtual const char *GetThrowSoundEffect() const
    {
        return NULL;
    }
    ...
    virtual void InitThrowable( float flChargePercent )
    {
        m_flChargePercent = flChargePercent;
    }

    virtual int GetProjectileType( void ) const OVERRIDE
    {
        return TF_PROJECTILE_THROWABLE;
    }
    ...
    {
        return GetTeamNumber() == TF_TEAM_RED ? "trail_basic_red" : "trail_basic_blue";
    }
#endif
...
class CTFProjectile_ThrowableRepel : public CTFProjectile_Throwable
{
   public:
    ...
    virtual void SetCustomPipebombModel()
    {
        SetModel( "models/weapons/c_models/c_balloon_default.mdl" );
    }
    virtual bool ExplodesOnHit()
    {
        return true;
    ...
    virtual float GetDamage()
    {
        return RemapVal( m_flChargePercent, 0, 1, 20.0f, 50.0f );
    }
    virtual float GetDamageRadius() const
    {
        return 0.0f;
...
class CTFProjectile_ThrowableBrick : public CTFProjectile_Throwable
{
   public:
    ...
    virtual void SetCustomPipebombModel()
    {
        SetModel( "models/weapons/c_models/c_bread/c_bread_plainloaf.mdl" );
    }
    virtual bool ExplodesOnHit()
    {
        return false;
    ...
    virtual float GetDamage()
    {
        return RemapVal( m_flChargePercent, 0, 1, 40.0f, 70.0f );
    }
    virtual float GetDamageRadius() const
    {
        return 0.0f;
...
class CTFProjectile_ThrowableBreadMonster : public CTFProjectile_Throwable
{
   public:
    ...
    virtual int GetProjectileType( void ) const OVERRIDE
    {
        return TF_PROJECTILE_BREAD_MONSTER;
    }
    ...
    virtual float GetDamage()
    {
        return RemapVal( m_flChargePercent, 0, 1, 40.0f, 85.0f );
    }
    virtual float GetDamageRadius() const
    {
        return 0.0f;
    ...
    virtual const char *GetExplodeEffectParticle() const
    {
        return "breadjar_impact";
    }
    virtual const char *GetThrowSoundEffect() const
    {
        return "Weapon_bm_throwable.throw";
    }
    virtual const char *GetExplodeEffectSound() const
    {
        return "Weapon_bm_throwable.smash";
    }
#endif  // GAME_DLL
};
