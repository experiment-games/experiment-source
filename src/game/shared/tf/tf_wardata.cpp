...
CWarDefinition::CWarDefinition()
    : m_nDefIndex( INVALID_WAR_DEF_INDEX ), m_pszLocalizedWarname( NULL ), m_pszDefName( NULL ), m_mapSides( DefLessFunc( SidesMap_t::KeyType_t ) ), m_rtTimeEnd( 0 ), m_rtTimeStart( 0 )
{
}
