...
#ifdef GAME_DLL
    : m_nClip( 0 ), m_nAmmo( 0 ), m_nDetonated( 0 ), m_flEnergy( 0.f ), m_flEffectBarRegenTime( 0.f ), m_flNextPrimaryAttack( 0.f ), m_flNextSecondaryAttack( 0.f ), m_bBroken( false ), m_flMeter( 0.f )
#endif
{
#ifdef CLIENT_DLL
    m_pGlowEffect = NULL;
