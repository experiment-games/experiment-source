...
class CTFProjectile_BallOfFire : public CTFProjectile_Rocket
{
   public:
    ...
    {
        Assert( false );
        return TF_DMG_CUSTOM_DRAGONS_FURY_IGNITE;
    }
    ...
    const char *GetParticle( bool bCrit ) const
    {
        return bCrit ? ( GetTeamNumber() == TF_TEAM_BLUE ? "projectile_fireball_crit_blue" : "projectile_fireball_crit_red" ) : "projectile_fireball";
    }
