...
void CTFWearableCampaignItem::FireGameEvent( IGameEvent *event )
{
    ...
    else if ( FStrEq( pszEvent, "player_spawn" ) || FStrEq( pszEvent, "inventory_updated" ) || FStrEq( pszEvent, "localplayer_changeclass" ) || FStrEq( pszEvent, "schema_updated" ) || FStrEq( pszEvent, "client_disconnect" ) )
    {
