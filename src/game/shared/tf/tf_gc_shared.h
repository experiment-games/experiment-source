...
class CReliableMessageQueue
{
   ...
   public:
    ...
    bool BStalled() const
    {
        return m_bCurrentMessageStalled;
    }
...
class IJobReliableMessage : public GCSDK::CGCClientJob
{
   ...
   protected:
    ...
    void SetStalled()
    {
        Queue().OnReliableMessageStalled( this );
    }

    CReliableMessageQueue &Queue()
    {
        return *m_pQueue;
    }
...
class CJobReliableMessageBase : public IJobReliableMessage
{
   public:
    ...
    CJobReliableMessageBase()
        : IJobReliableMessage( GCClientSystem()->GetGCClient() ), m_msg( E_MSG_TYPE ), m_msgReply()
    {
    }
   ...
   private:
    ...
    {
        return static_cast< RELIABLE_MSG_CLASS * >( this );
    }
    ...
    {
        return m_strDebug.Get();
    }

    // Forward to override
    const char *GetMsgName()
    {
        return ReliableMsg()->MsgName();
    }
