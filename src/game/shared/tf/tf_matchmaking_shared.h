...
inline const char *EMMRating_DisplayedForGDPR( EMMRating eRatingType )
{
    switch ( eRatingType )
    {
        ...
        case k_nMMRating_6v6_GLICKO:
            return "Competitive_Glicko";
        case k_nMMRating_Casual_XP:
            return "Casual_XP";
        case k_nMMRating_Casual_XP_PlayerAcknowledged:
            return "Casual_XP_Acknowledged";
        case k_nMMRating_6v6_Rank:
            return "Competitive_Rank";
        case k_nMMRating_6v6_Rank_PlayerAcknowledged:
            return "Competitive_Rank_Acknowledged";
        case k_nMMRating_Casual_12v12_Rank:
            return "Casual_Rank";
        case k_nMMRating_Casual_12v12_Rank_PlayerAcknowledged:
            return "Casual_Rank_Acknowledged";
        case k_nMMRating_6v6_GLICKO_PlayerAcknowledged:
            return "Competitive_Glicko_Acknowledged";
        case k_nMMRating_Comp_12v12_Rank:
            return "Competitive_Event_Rank";
        case k_nMMRating_Comp_12v12_Rank_PlayerAcknowledged:
            return "Competitive_Event_Rank_Acknowledged";
        case k_nMMRating_Comp_12v12_GLICKO:
            return "Competitive_Event_Glicko";
        case k_nMMRating_Comp_12v12_GLICKO_PlayerAcknowledged:
            return "Competitive_Event_Glicko_Acknowledged";
        case k_nMMRating_6v6_DRILLO:
            return "Competitive_Drillo";  // Was displayed at one point, if they have it, show it
        case k_nMMRating_6v6_DRILLO_PlayerAcknowledged:
            return "Competitive_Drillo_Acknowledged";
...
{
    return ( eMatchGroup >= k_eTFMatchGroup_Ladder_First && eMatchGroup <= k_eTFMatchGroup_Ladder_Last ) || ( eMatchGroup >= k_eTFMatchGroup_Casual_First && eMatchGroup <= k_eTFMatchGroup_Casual_Last ) || eMatchGroup == k_eTFMatchGroup_Event_Placeholder;
}
...
class CCasualCriteriaHelper
{
   public:
    ...
    bool operator==( const CCasualCriteriaHelper &other ) const
    {
