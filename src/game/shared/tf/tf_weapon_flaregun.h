...
// Server specific.
    ...
    int GetFlareGunType( void ) const
    {
        int iMode = 0;
    ...
    virtual const char* GetChargeEffect( void ) const
    {
        return "drg_cowmangler_muzzleflash_chargeup";
    }

    float GetChargeBeginTime( void ) const
    {
...
class CTFFlareGun_Revenge : public CTFFlareGun
{
   public:
    ...
    virtual int GetWeaponID( void ) const
    {
        return TF_WEAPON_FLAREGUN_REVENGE;
    }
    ...
    const char* GetMuzzleFlashParticleEffect( void )
    {
        return "drg_manmelter_muzzleflash";
    }
    ...
    virtual const char* GetChargeEffect( void ) const
    {
        return "drg_manmelter_vacuum";
    }
    virtual const char* ReadyToFireSound( void ) const
    {
        return "Weapon_SniperRailgun.NonScoped";
    }
