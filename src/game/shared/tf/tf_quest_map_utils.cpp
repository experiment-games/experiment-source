...
CQuestMapHelper::CQuestMapHelper( CSteamID steamID )
    : m_mapNodes( DefLessFunc( uint32 ) ), m_steamID( steamID ), m_mapStarsAvailableToSpend( DefLessFunc( uint32 ) ), m_mapStarsEarned( DefLessFunc( uint32 ) ), m_mapStarsTotal( DefLessFunc( uint32 ) ), m_mapRewardDefindexPurchases( DefLessFunc( uint32 ) )
{
    Refresh();
}
...
CQuestMapHelper::CQuestMapHelper()
    : m_mapNodes( DefLessFunc( uint32 ) ), m_mapNodeConnections( DefLessFunc( uint64 ) ), m_mapRegionHasAvailableContracts( DefLessFunc( uint32 ) ), m_mapStarsAvailableToSpend( DefLessFunc( uint32 ) ), m_mapStarsEarned( DefLessFunc( uint32 ) ), m_mapStarsTotal( DefLessFunc( uint32 ) ), m_mapRewardDefindexPurchases( DefLessFunc( uint32 ) )
{
