...
class CTFPointManager : public CBaseEntity
{
   ...
   protected:
    ...
    virtual Vector GetInitialVelocity() const
    {
        return vec3_origin;
    }

#ifdef GAME_DLL
    virtual bool ShouldCollide( CBaseEntity *pEnt ) const
    {
        return true;
    }
    ...
    virtual tf_point_t *AllocatePoint()
    {
        return new tf_point_t;
    }
    ...
    virtual float GetDrag() const
    {
        return 0.f;
    }
    virtual Vector GetAdditionalVelocity( const tf_point_t *pPoint ) const
    {
        return vec3_origin;
    }

    virtual float GetRadius( const tf_point_t *pPoint ) const
    {
        return 0.f;
    }
    ...
    const TFPointVec_t &GetPointVec() const
    {
        return m_vecPoints;
    }
    ...
    {
        return m_vecPoints.Count() < GetMaxPoints();
    }
