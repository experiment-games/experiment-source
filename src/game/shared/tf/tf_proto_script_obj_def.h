...
void GetMessageFromFieldID( const CMsgFieldID& startingFieldID, const google::protobuf::Message* pStartingMsg, CMsgFieldID_CMsgField& outerFieldID, const google::protobuf::Message** pOuterMsg );
void GetMutableMessageFromFieldID( const CMsgFieldID& startingFieldID, google::protobuf::Message* pStartingMsg, CMsgFieldID_CMsgField& outerFieldID, google::protobuf::Message** pOuterMsg );
...
struct ProtoDefID_t
{
    ...
    ProtoDefID_t( ProtoDefTypes eType, uint32 nDefIndex )
    {
        SetDef( eType, nDefIndex );
    }
    ...
    void SetDef( const CMsgProtoDefID& id )
    {
        m_ID = id;
    }
    void SetDef( const ProtoDefID_t& id )
    {
        m_ID = id.m_ID;
    }
...
class IProtoBufScriptObjectDefinition
{
    ...
    virtual bool BOnDataLoaded( CUtlVector< CUtlString >* pVecErrors )
    {
        return true;
    }
...
class CTypedProtoBufScriptObjectDefinition : public IProtoBufScriptObjectDefinition
{
    ...
    ProtoDefTypes GetDefType() const OVERRIDE
    {
        return DefType;
    }
    ...
    google::protobuf::Message* GetMutableMsg() OVERRIDE
    {
        return &m_msgData;
    }
...
class CProtoDefReferenceFinder : public CAutoGameSystemPerFrame
{
    ...
    ProtoDefID_t GetDefID() const
    {
        return m_defID;
    }
    const CUtlVector< ProtoDefID_t >& GetReferences() const
    {
        return m_vecReferences;
    }
    const CUtlVector< ProtoDefID_t >& GetDerivedDefs() const
    {
    ...
    : public CAutoGameSystemPerFrame
{
    ...
    bool BDefinitionsLoaded() const
    {
        return m_bDefinitionsLoaded && m_bDefinitionsPostDataLoadedCalled;
    }
    bool BPostDefinitionsLoaded();
    bool BPostDefinitionsCalled() const
    {
        return m_bDefinitionsPostDataLoadedCalled;
    }
    ...
    const DefinitionMap_t& GetDefinitionMapForType( ProtoDefTypes eType ) const
    {
        return m_arDefinitionsMaps[eType];
    }
