...
struct CMannVsMachinePlayerStats
{
    CMannVsMachinePlayerStats()
        : nDeaths( 0 ), nBotDamage( 0 ), nGiantDamage( 0 ), nTankDamage( 0 )
    {
    }
...
struct CPlayerWaveSpendingStats
{
    CPlayerWaveSpendingStats()
        : nCreditsSpentOnBuyBacks( 0 ), nCreditsSpentOnBottles( 0 ), nCreditsSpentOnUpgrades( 0 )
    {
    }
...
class CMannVsMachineStats : public CBaseEntity
{
    ...
    uint32 GetCurrentWave() const
    {
        return m_iCurrentWaveIdx;
    }
    ...
    void SetPopFile( const char *pPopFile )
    {
        m_pPopFileName = pPopFile;
    }
    ...
    CUtlVector< CUpgradeInfo > *GetLocalPlayerUpgrades()
    {
        return &m_vecLocalPlayerUpgrades;
    }
    ...
    // Respec
    uint16 GetNumRespecsEarnedInWave( void )
    {
        return m_nRespecsAwardedInWave;
    }
    uint32 GetAcquiredCreditsForRespec( void )
    {
        return m_iCurrencyCollectedForRespec;
    }
#ifdef GAME_DLL
    void SetNumRespecsEarnedInWave( uint16 nNum )
    {
        m_nRespecsAwardedInWave = nNum;
    }
    void SetAcquiredCreditsForRespec( uint16 nNum )
    {
        m_iCurrencyCollectedForRespec = nNum;
    }
#endif  // GAME_DLL
