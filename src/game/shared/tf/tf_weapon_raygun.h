...
class CTFRaygun : public CTFRocketLauncher
{
   public:
    ...
    virtual const char *GetIdleParticleEffect( void )
    {
        return "drg_bison_idle";
    }
#endif

    bool UseNewProjectileCode() const
    {
...
class CTFDRGPomson : public CTFRaygun
{
   public:
    ...
    const char *GetEffectLabelText( void )
    {
        return "#TF_POMSON_HUD";
    }

    virtual const char *GetMuzzleFlashParticleEffect( void )
    {
        return "drg_pomson_muzzleflash";
    }
    virtual const char *GetIdleParticleEffect( void )
    {
        return "drg_pomson_idle";
    }
