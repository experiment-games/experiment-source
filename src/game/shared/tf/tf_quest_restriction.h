...
class CTFQuestCondition
{
   public:
    ...
    virtual const char* GetConditionName() const
    {
    ...
    void SetParent( CTFQuestCondition* pParent )
    {
        m_pParent = pParent;
    }
    CTFQuestCondition* GetParent() const
    {
        return m_pParent;
    }

    virtual CTFQuestCondition* AddChildByName( const char* pszChildName )
    {
        Assert( 0 );
        return NULL;
    }

    virtual int GetChildren( CUtlVector< CTFQuestCondition* >& vecChildren )
    {
        return 0;
    }
    virtual bool RemoveAndDeleteChild( CTFQuestCondition* pChild )
    {
        return false;
    }
    ...
    virtual void SetEventName( const char* pszEventName )
    {
        Assert( 0 );
    }

    void SetFieldName( const char* pszFieldName )
    {
...
class CTFQuestRestriction : public CTFQuestCondition
{
   public:
    ...
    void SetEventName( const char* pszEventName ) OVERRIDE
    {
...
class CTFConditionQuestModifier : public ITFQuestModifier
{
   public:
    ...
    bool BPassesModifier( const CTFPlayer* pOwner, InvalidReasonsContainer_t& invalidReasons ) const OVERRIDE;
    void AddCondition( ETFCond eCond )
    {
