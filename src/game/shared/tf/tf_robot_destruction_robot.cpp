...
CTFRobotDestruction_RobotAnimController::CTFRobotDestruction_RobotAnimController( CTFRobotDestruction_Robot *pOuter )
    : m_vecOldOrigin( vec3_origin ), m_vecLean( vec3_origin ), m_pOuter( pOuter ), m_vecImpulse( vec3_origin )
{
}
...
//---------------------------------------------------------------------------------------------
CRobotIntention::CRobotIntention( CTFRobotDestruction_Robot *pMe )
    : IIntention( pMe )
{
