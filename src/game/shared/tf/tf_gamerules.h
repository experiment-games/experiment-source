...
class CTFGameRules : public CTeamplayRoundBasedRules
{
    ...
    void SetRopesHolidayLightsAllowed( bool bAllowed )
    {
        m_bRopesHolidayLightsAllowed = bAllowed;
    }
    ...
    bool GetRopesHolidayLightsAllowed( void )
    {
    ...
    void ForceEnableUpgrades( int nState )
    {
        m_nForceUpgrades = nState;
    }
    void ForceEscortPushLogic( int nState )
    {
