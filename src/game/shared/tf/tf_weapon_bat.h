...
class CTFBat_Wood : public CTFBat
{
   public:
    ...
    {
        return "models/weapons/v_models/v_baseball.mdl";
    }
...
class CTFStunBall : public CTFGrenadePipebombProjectile
{
   public:
    ...
    void SetInitialSpeed( float flSpd )
    {
        m_flInitialSpeed = flSpd;
    }

    virtual int GetWeaponID( void ) const
    {
        return TF_WEAPON_GRENADE_STUNBALL;
    }
    virtual const char *GetBallModelName( void ) const;
    virtual const char *GetBallViewModelName( void ) const;

    virtual bool IsAllowedToExplode( void ) OVERRIDE
    {
        return false;
    }
...
class CTFBall_Ornament : public CTFStunBall
{
   public:
    ...
    virtual int GetWeaponID( void ) const
    {
        return TF_WEAPON_GRENADE_ORNAMENT_BALL;
    }
    virtual const char *GetBallModelName( void ) const;
    virtual const char *GetBallViewModelName( void ) const;
