...
#ifdef CLIENT_DLL
    const LeaderBoardEntries_t& GetGlobalLeaderboardScores() const
    {
        return downloadedLeaderboardScoresGlobal;
    }
    const LeaderBoardEntries_t& GetFriendsLeaderboardScores() const
    {
        return downloadedLeaderboardScoresFriends;
    }
#endif  // CLIENT_DLL
