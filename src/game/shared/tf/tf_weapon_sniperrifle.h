...
class CTFSniperRifle : public CTFWeaponBaseGun
{
   public:
    ...
    virtual float SniperRifleChargeRateMod()
    {
        return 0.f;
    }
...
class CTFSniperRifleDecap : public CTFSniperRifle
{
   public:
    ...
    virtual int GetWeaponID( void ) const
    {
        return TF_WEAPON_SNIPERRIFLE_DECAP;
    }
...
class CTFSniperRifleClassic : public CTFSniperRifle
{
   public:
    ...
    virtual int GetWeaponID( void ) const
    {
        return TF_WEAPON_SNIPERRIFLE_CLASSIC;
    }
    ...
    virtual bool MustBeZoomedToFire( void ) OVERRIDE
    {
        return false;
    }
