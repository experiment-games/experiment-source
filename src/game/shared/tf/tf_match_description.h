...
class IMatchGroupDescription
{
   public:
    ...
    inline int GetMatchSize() const
    {
        return m_pmm_match_group_size->GetInt();
    }
    inline bool BShouldAutomaticallyRequeueOnMatchEnd() const
    {
        return m_bAutomaticallyRequeueAfterMatchEnds;
    }
    inline bool BUsesMapVoteAfterMatchEnds() const
    {
        return m_bUsesMapVoteOnRoundEnd;
    }
    inline bool BScramblesTeamsOnRollingMatch() const
    {
        return m_bScramblesTeamsOnRollingMatch;
    }
    inline bool BUsesXP() const
    {
        return m_bUsesXP;
    }
    inline bool BUsesDashboard() const
    {
        return m_bUsesDashboardOnRoundEnd;
    }
    inline bool BUsesStrictMatchmakerScoring() const
    {
        return m_bStrictMatchmakerScoring;
    }
    inline bool BRequiresCompleteMatches() const
    {
        return m_bRequireCompleteMatch;
    }
    inline const char* GetNameLocToken() const
    {
        return m_pszModeNameLocToken;
    }
    inline const char* GetRichPresenceLocToken() const
    {
        return m_pszRichPresenceLocToken;
    }
    inline bool BAllowsPartyJoins() const
    {
        return m_bAllowPartyJoins;
    }
    inline bool BAllowsPartySpectate() const
    {
        return m_bAllowPartySpectate;
    }
    inline bool BAllowsQuestProgress() const
    {
        return m_bContractProgressAllowed;
    }
    inline EMMPenaltyPool GetPenaltyPool() const
    {
        return m_ePenaltyPool;
    }
    inline float GetRequiredMatchmakingScore() const
    {
        return m_pmm_required_score->GetFloat();
    }  // TODO: What if no m_pmm_required_score?
    inline bool BSupportLowPriorityQueue() const
    {
        return m_bSupportsLowPriorityQueue;
    }
    inline EMatchMode GetLateJoinMode() const
    {
        return m_eLateJoinMode;
    }
    inline EMatchType_t GetMatchType() const
    {
        return m_eMatchType;
    }
    inline bool BUsesFixedWeaponSpread() const
    {
        return m_bFixedWeaponSpread;
    }
    inline bool BUsesAutoBalance() const
    {
        return m_bUseAutoBalance;
    }
    inline bool BUsesAutoReady() const
    {
        return m_bAutoReady;
    }
    inline bool BUsesPreRoundDoors() const
    {
        return m_bShowPreRoundDoors;
    }
    inline bool BUsesPostRoundDoors() const
    {
        return m_bShowPostRoundDoors;
    }
    inline bool BDistributePerformanceMedals() const
    {
        return m_bDistributePerformanceMedals;
    }
    inline bool BUsesMatchHUD() const
    {
        return m_bUseMatchHud;
    }
    inline bool BAllowDrawingAtMatchHistory() const
    {
        return m_bAllowDrawingAtMatchSummary;
    }
    inline bool BUseMatchSummaryStage() const
    {
        return m_bUseMatchSummaryStage;
    }
    inline const char* GetMatchEndKickWarning() const
    {
        return m_pszMatchEndKickWarning;
    }
    inline bool BAllowTeamChange() const
    {
        return m_bAllowTeamChange;
    }
    inline bool BAllowSpectatorModeChange() const
    {
        return m_bAllowSpecModeChange;
    }
    inline bool BUsesRandomCrits() const
    {
        return m_bRandomWeaponCrits;
    }
    inline bool BForceClientSettings() const
    {
        return m_bForceClientSettings;
    }
    inline const char* GetMatchStartSound() const
    {
        return m_pszMatchStartSound;
    }
    inline int GetNumWinsToExitPlacement() const
    {
        return m_nNumWinsToExitPlacement;
    }
    inline int GetNumPlacementMatchesPerDay() const
    {
        return m_nNumPlacementMatchesPerDay;
    }
    inline bool BUsesPlacementMatches() const
    {
        return m_nNumWinsToExitPlacement > 0;
    }
    inline EMMRating GetCurrentDisplayRating() const
    {
        return m_eCurrentDisplayRating;
    }
    inline EMMRating GetLastAckdDisplayRating() const
    {
        return m_eLastAckdDisplayRating;
    }
    inline EMMRating GetCurrentDisplayRank() const
    {
        return m_eCurrentDisplayRank;
    }
    inline EMMRating GetLastAckdDisplayRank() const
    {
        return m_eLastAckdDisplayRank;
    }
    inline bool BUsesStickyRanks() const
    {
        return m_bUsesStickyRanks;
    }
    inline bool BUsesStrictAbandons() const
    {
        return m_bUsesStrictAbandons;
    }
    inline bool BRequiresCompetitiveAccess() const
    {
        return m_bRequiresCompetitiveAccess;
    }
    inline EMatchGroupLeaderboard GetLeaderboard() const
    {
        return m_eLeaderboard;
    }
    inline bool BUsesStrictSpectatorRules() const
    {
        return m_bUsesStrictSpectatorRules;
    }

    // Meta-permissions that are based on other set flags
    //
    // Only match-vote modes need this ability right now
    inline bool BCanServerRequestNewMatchForLobby() const
    {
        return BUsesMapVoteAfterMatchEnds();
    }
    ...
    inline bool BCanServerChangeMatchPlayerTeams() const
    {
        return BCanServerRequestNewMatchForLobby() || m_bUseAutoBalance;
    }

    inline bool BIsTrustedServersOnly() const
    {
        return m_bTrustedServersOnly;
    }
