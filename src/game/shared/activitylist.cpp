...
void ActivityList_RegisterSharedActivities( void )
{
    ...
    REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOYED_LIFTED_IN );
    REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOYED_LIFTED_OUT );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_VM_FIRE_TO_EMPTY );
    REGISTER_SHARED_ACTIVITY( ACT_VM_FIREMODE );
    REGISTER_SHARED_ACTIVITY( ACT_VM_HITKILL );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_INSERT_EMPTY );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_VM_UNLOAD );

    REGISTER_SHARED_ACTIVITY( ACT_CROSSBOW_HOLSTER_UNLOADED );

    REGISTER_SHARED_ACTIVITY( ACT_DRIVE_AIRBOAT );
    REGISTER_SHARED_ACTIVITY( ACT_DRIVE_JEEP );
    REGISTER_SHARED_ACTIVITY( ACT_DRIVE_POD );

    REGISTER_SHARED_ACTIVITY( ACT_FLINCH );
    REGISTER_SHARED_ACTIVITY( ACT_FLINCH_BACK );
    REGISTER_SHARED_ACTIVITY( ACT_FLINCH_SHOULDER_LEFT );
    REGISTER_SHARED_ACTIVITY( ACT_FLINCH_SHOULDER_RIGHT );

    REGISTER_SHARED_ACTIVITY( ACT_GMOD_DEATH );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_AGREE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_BECON );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_BOW );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_DISAGREE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_ITEM_DROP );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_ITEM_GIVE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_ITEM_PLACE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_ITEM_THROW );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_MELEE_SHOVE_1HAND );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_MELEE_SHOVE_2HAND );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_POINT );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_RANGE_FRENZY );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_RANGE_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_RANGE_ZOMBIE_SPECIAL );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_TAUNT_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_WAVE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_IN_CHAT );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_NOCLIP_LAYER );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_DUCK_01 );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_DUCK_02 );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_STAND_01 );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_STAND_02 );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_STAND_03 );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_STAND_04 );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SIT_ROLLERCOASTER );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_CHEER );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_DANCE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_LAUGH );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_MUSCLE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_PERSISTENCE );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_ROBOT );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_SALUTE );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_FIST_BLOCK );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_ZOMBIE );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_COWER );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_ZOMBIE_01 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_ZOMBIE_02 );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_MELEE_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_ZOMBIE );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_ZOMBIE );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_CHARGING );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_FAST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_PANICKED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_PROTECTED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_ZOMBIE_FAST );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_AR2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_CROSSBOW );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_GRENADE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_MELEE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_PHYSGUN );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_PISTOL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_RPG );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_SHOTGUN );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_SLAM );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SIT_SMG1 );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_AR2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_CROSSBOW );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_DUEL );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_AR2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_CROSSBOW );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_GRENADE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_MELEE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_PASSIVE );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_RPG );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SHOTGUN );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SLAM );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SMG1 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_MELEE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_PASSIVE );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_RPG );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SHOTGUN );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SLAM );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SMG1 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_ZOMBIE );

    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_AR2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROSSBOW );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ANGRY );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_CAMERA );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_MELEE2 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_PASSIVE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_REVOLVER );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_SCARED );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_SUITCASE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ZOMBIE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ZOMBIE_01 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ZOMBIE_02 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ZOMBIE_03 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ZOMBIE_04 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_ZOMBIE_05 );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_DUEL );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_FIST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_GRENADE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_KNIFE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_MAGIC );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_MELEE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_MELEE2 );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_SCARED );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_ZOMBIE_SLUMP_ALT_IDLE );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_ZOMBIE_SLUMP_ALT_RISE_FAST );
    REGISTER_SHARED_ACTIVITY( ACT_HL2MP_ZOMBIE_SLUMP_ALT_RISE_SLOW );
