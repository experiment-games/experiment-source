...
#ifdef CLIENT_DLL
#include "experiment/c_experiment_player.h"
#endif
#endif
...
#else
#if defined( EXPERIMENT_SOURCE ) && defined( CLIENT_DLL )
    C_Experiment_Player *pHL2Player = static_cast< C_Experiment_Player * >( player );
#else
