...
bool CHL2GameMovement::ExitLadderViaDismountNode( CFuncLadder *ladder, bool strict, bool useAlternate )
{
    ...
    if ( found )
    {
        ...
        StartForcedMove( false, player->GetMaxSpeed(), bestDest, NULL );
        return true;
    }
    ...
    if ( useAlternate )
    {
        ...
        {
            StartForcedMove( false, player->GetMaxSpeed(), alternateDest, NULL );
            return true;
        }
    }
...
bool CHL2GameMovement::CheckLadderAutoMountEndPoint( CFuncLadder *ladder, const Vector &bestOrigin )
{
    ...
    {
        StartForcedMove( true, player->GetMaxSpeed(), bestOrigin, ladder );
        return true;
    }
