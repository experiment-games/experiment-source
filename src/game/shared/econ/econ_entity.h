...
class CEconEntity : public CBaseAnimating, public IHasAttributes
{
   ...
   public:
    ...
    void MarkAttachedEntityAsValidated()
    {
    ...
    virtual bool ShouldShowToolTip( void )
    {
        return true;
    }
    ...
    virtual bool AttachmentModelsShouldBeVisible( void )
    {
        return true;
    }
    ...
    {
        return ( m_hViewmodelAttachment != NULL );
    }
    virtual int LookupAttachment( const char *pAttachmentName );
    virtual bool GetAttachment( const char *szName, Vector &absOrigin )
    {
        return BaseClass::GetAttachment( szName, absOrigin );
    }
    virtual bool GetAttachment( const char *szName, Vector &absOrigin, QAngle &absAngles )
    {
        return BaseClass::GetAttachment( szName, absOrigin, absAngles );
    }
    ...
    C_BaseAnimating *GetViewmodelAttachment( void )
    {
        return m_hViewmodelAttachment.Get();
    }
   ...
   public:
    ...
    const CAttributeContainer *GetAttributeContainer( void ) const
    {
        return &m_AttributeManager;
    }
    ...
    {
        return m_AttributeManager.GetItem()->GetAttributeList();
    }
...
class C_ViewmodelAttachmentModel : public C_BaseAnimating, public IHasOwner
{
   ...
   public:
    ...
    {
        return GetOuter()->GetAttributeOwner();
    }
