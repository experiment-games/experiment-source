...
class CQuestThemeDefinition : public CTypedProtoBufScriptObjectDefinition< CMsgQuestTheme, DEF_TYPE_QUEST_THEME >
{
    ...
    const char* GetNotificationResFile() const
    {
        return m_msgData.notification_res().c_str();
    }
    const char* GetQuestItemResFile() const
    {
        return m_msgData.quest_item_res().c_str();
    }
    const char* GetInGameTrackerResFile() const
    {
        return m_msgData.in_game_tracker_res().c_str();
    }
    ...
    const char* GetDiscardSound() const
    {
        return UTIL_GetRandomSoundFromEntry( m_msgData.discard_sound().c_str() );
    }
    const char* GetRewardSound() const
    {
        return UTIL_GetRandomSoundFromEntry( m_msgData.reward_sound().c_str() );
    }
    const char* GetRevealSound() const
    {
...
class CQuestObjectiveConditionsDefinition
{
    ...
    ObjectiveConditionDefIndex_t GetDefIndex() const
    {
        return m_nDefIndex;
    }
    KeyValues* GetKeyValues() const
    {
        return m_pConditionsKey;
    }

    const CUtlVector< CTFRequiredQuestItemsSet >& GetRequiredItemSets() const
    {
...
class CQuestObjectiveDefinition : public CTypedProtoBufScriptObjectDefinition< CMsgQuestObjectiveDef, DEF_TYPE_QUEST_OBJECTIVE >
{
    ...
    const char* GetDescriptionToken( void ) const
    {
        return m_msgData.loc_desctoken().c_str();
    }
    const CQuestObjectiveConditionsDefinition* GetConditions() const;
    int GetPoints() const
    {
        return m_msgData.points();
    }
...
struct QuestObjectiveInstance_t
{
    ...
    EQuestPoints GetPointsType() const
    {
        return m_objective.point_type();
    }
    int GetPoints() const
    {
    ...
    const CQuestObjectiveDefinition* GetObjectiveDef() const
    {
        return m_pDef;
    }
...
class CQuestDefinition : public CTypedProtoBufScriptObjectDefinition< CMsgQuestDef, DEF_TYPE_QUEST >
{
    ...
    const char* GetMatchmakingGroupName() const
    {
        return m_msgData.mm_criteria().group_name().c_str();
    }
    const char* GetMatchmakingCategoryName() const
    {
        return m_msgData.mm_criteria().category_name().c_str();
    }
    const char* GetMatchmakingMapName() const
    {
        return m_msgData.mm_criteria().map_name().c_str();
    }

    const QuestObjectiveDefVec_t& GetObjectives() const
    {
        return m_vecObjectives;
    }
    ...
    const char* GetCorrespondingOperationName() const
    {
        return m_msgData.operation().c_str();
    }
    const CUtlVector< item_definition_index_t >& GetLoanerItems() const
    {
        return m_vecLoanerDefindex;
    }
    const char* GetNodeImageFileName() const
    {
        return m_msgData.node_image().c_str();
    }
    const char* GetNodeIconFileName() const
    {
        return m_msgData.icon_image().c_str();
    }
...
class CQuest : public GCSDK::CProtoBufSharedObject< CSOQuest, k_EEConTypeQuest >
{
    ...
    uint32 GetSourceNodeID() const
    {
        return Obj().quest_map_node_source_id();
    }
};
