...
CQuestObjectiveConditionsDefinition::CQuestObjectiveConditionsDefinition( void )
    : m_nDefIndex( INVALID_QUEST_OBJECTIVE_CONDITIONS_INDEX ), m_pConditionsKey( NULL )
{
}
...
uint32 CQuestDefinition::GetMaxPoints( uint32 nIndex ) const
{
    ...
    {
        case 0:
            return m_msgData.max_points_0();
        case 1:
            return m_msgData.max_points_1();
        case 2:
            return m_msgData.max_points_2();
    }
