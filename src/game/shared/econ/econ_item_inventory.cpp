...
#ifdef CLIENT_DLL
    : m_mapPersonaNamesCache( DefLessFunc( uint32 ) ), m_sPersonaStateChangedCallback( this, &CInventoryManager::OnPersonaStateChanged ), m_personaNameRequests( DefLessFunc( uint64 ) )
#endif
{
#ifdef CLIENT_DLL
...
CPlayerInventory::CPlayerInventory( void )
    : m_mapItemDefsToItems( DefLessFunc( item_definition_index_t ) ), m_mapPaintkitsToItems( DefLessFunc( uint32 ) )
{
