...
enum
{
    kLocalizedPriceSizeInChararacters = 64
};
...
enum EItemActionMissingBehavior
{
    kEItemAction_FriendlyNameLookup_ReturnNULLIfMissing,
    kEItemAction_FriendlyNameLookup_ReturnDummyStringIfMissing
};
...
{
    return eCartType == kCartItem_Rental_1Day || eCartType == kCartItem_Rental_3Day || eCartType == kCartItem_Rental_7Day;
}
