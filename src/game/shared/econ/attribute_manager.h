...
template < class T >
T AttributeConvertFromFloat( float flValue );
template <>
float AttributeConvertFromFloat< float >( float flValue );
template <>
int AttributeConvertFromFloat< int >( float flValue );
...
class CAttributeManager
{
    ...
    CBaseEntity *GetOuter( void ) const
    {
        return m_hOuter.Get();
    }
    ...
    void SetProviderType( attributeprovidertypes_t tType )
    {
        m_ProviderType = tType;
    }
    attributeprovidertypes_t GetProviderType( void ) const
    {
    ...
    template < class T >
    static T AttribHookValue( T TValue, const char *pszAttribHook, const CBaseEntity *pEntity, CUtlVector< CBaseEntity * > *pItemList = NULL, bool bIsGlobalConstString = false )
    {
    ...
    template < class T >
    static void AttribHookValueInternal( T &out, T TValue, const char *pszAttribHook, const CBaseEntity *pEntity, IHasAttributes *pAttribInterface, CUtlVector< CBaseEntity * > *pItemList, bool bIsGlobalConstString )
    {
...
class CAttributeContainer : public CAttributeManager
{
    ...
    const CEconItemView *GetItem( void ) const
    {
        return &m_Item;
    }
