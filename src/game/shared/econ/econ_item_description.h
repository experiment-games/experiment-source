...
class IEconItemDescription
{
    ...
    {
        return m_vecDescLines.Count();
    }
    const econ_item_description_line_t &GetLine( int i ) const
    {
        return m_vecDescLines[i];
    }
...
class CEconAttributeDescription
{
    ...
    const CUtlConstStringBase< locchar_t > &GetDescription() const
    {
        return m_loc_sValue;
    }
    const CUtlConstStringBase< locchar_t > &GetShortDescription() const
    {
        return m_loc_sShortValue;
    }
    attrib_colors_t GetDefaultColor() const
    {
