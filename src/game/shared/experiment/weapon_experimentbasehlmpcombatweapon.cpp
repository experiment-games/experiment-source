...
LINK_ENTITY_TO_CLASS( baseexperimentcombatweapon, CBaseExperimentCombatWeapon );

IMPLEMENT_NETWORKCLASS_ALIASED( BaseExperimentCombatWeapon, DT_BaseExperimentCombatWeapon )

BEGIN_NETWORK_TABLE( CBaseExperimentCombatWeapon, DT_BaseExperimentCombatWeapon )
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CBaseExperimentCombatWeapon )
...
DEFINE_FIELD( m_bLowered, FIELD_BOOLEAN ),
    ...
    END_DATADESC()
        ...
        BEGIN_PREDICTION_DATA( CBaseExperimentCombatWeapon )
            END_PREDICTION_DATA()

                extern ConVar sk_auto_reload_time;

CBaseExperimentCombatWeapon::CBaseExperimentCombatWeapon( void )
{
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CBaseExperimentCombatWeapon::ItemHolsterFrame( void )
{
...
//-----------------------------------------------------------------------------
bool CBaseExperimentCombatWeapon::Lower( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseExperimentCombatWeapon::Ready( void )
{
    // Don't bother if we don't have the animation
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseExperimentCombatWeapon::Deploy( void )
{
    // If we should be lowered, deploy in the lowered position
    // We have to ask the player if the last time it checked, the weapon was lowered
    if ( GetOwner() && GetOwner()->IsPlayer() )
    {
        CExperiment_Player *pPlayer = assert_cast< CExperiment_Player * >( GetOwner() );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseExperimentCombatWeapon::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseExperimentCombatWeapon::WeaponShouldBeLowered( void )
{
...
//-----------------------------------------------------------------------------
void CBaseExperimentCombatWeapon::WeaponIdle( void )
{
...
// Output : float
//-----------------------------------------------------------------------------
float CBaseExperimentCombatWeapon::CalcViewmodelBob( void )
{
...
//			viewmodelindex -
//-----------------------------------------------------------------------------
void CBaseExperimentCombatWeapon::AddViewmodelBob( CBaseViewModel *viewmodel, Vector &origin, QAngle &angles )
{
...
//-----------------------------------------------------------------------------
Vector CBaseExperimentCombatWeapon::GetBulletSpread( WeaponProficiency_t proficiency )
{
    return BaseClass::GetBulletSpread( proficiency );
}

//-----------------------------------------------------------------------------
float CBaseExperimentCombatWeapon::GetSpreadBias( WeaponProficiency_t proficiency )
{
    return BaseClass::GetSpreadBias( proficiency );
}
//-----------------------------------------------------------------------------

const WeaponProficiencyInfo_t *CBaseExperimentCombatWeapon::GetProficiencyValues()
{
    return NULL;
}
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CBaseExperimentCombatWeapon::GetDefaultProficiencyValues()
{
