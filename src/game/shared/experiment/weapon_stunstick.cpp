...
class CWeaponStunStick : public CBaseExperimentBludgeonWeapon
{
    DECLARE_CLASS( CWeaponStunStick, CBaseExperimentBludgeonWeapon );
...
void CWeaponStunStick::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
    switch ( pEvent->event )
    {
        case EVENT_WEAPON_MELEE_HIT:
        {
            ...
            CBaseEntity *pHurt = pOperator->CheckTraceHullAttack( pOperator->Weapon_ShootPosition(), vecEnd, Vector( -16, -16, -40 ), Vector( 16, 16, 16 ), GetDamageForActivity( GetActivity() ), DMG_CLUB, 0.5f, false );
