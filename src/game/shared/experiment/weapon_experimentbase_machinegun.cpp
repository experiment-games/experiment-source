...
#include "weapon_experimentbase_machinegun.h"
#include "in_buttons.h"

// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

IMPLEMENT_NETWORKCLASS_ALIASED( ExperimentMachineGun, DT_ExperimentMachineGun )

BEGIN_NETWORK_TABLE( CExperimentMachineGun, DT_ExperimentMachineGun )
END_NETWORK_TABLE()

BEGIN_PREDICTION_DATA( CExperimentMachineGun )
END_PREDICTION_DATA()

//=========================================================
//	>> CHLSelectFireMachineGun
//=========================================================
BEGIN_DATADESC( CExperimentMachineGun )
...
DEFINE_FIELD( m_nShotsFired, FIELD_INTEGER ),
    ...
    // Purpose:
    //-----------------------------------------------------------------------------
    CExperimentMachineGun::CExperimentMachineGun( void )
{
}

const Vector &CExperimentMachineGun::GetBulletSpread( void )
{
...
//
//-----------------------------------------------------------------------------
void CExperimentMachineGun::PrimaryAttack( void )
{
    ...
    CExperiment_Player *pExperimentPlayer = ToExperimentPlayer( pPlayer );

    // Fire the bullets
    FireBulletsInfo_t info;
    info.m_iShots = iBulletsToFire;
    info.m_vecSrc = pExperimentPlayer->Weapon_ShootPosition();
    info.m_vecDirShooting = pPlayer->GetAutoaimVector( AUTOAIM_5DEGREES );
    info.m_vecSpread = pExperimentPlayer->GetAttackSpread( this );
    ...
    ToExperimentPlayer( pPlayer )->DoAnimationEvent( PLAYERANIMEVENT_ATTACK_PRIMARY );
}
...
// Input  : &info -
//-----------------------------------------------------------------------------
void CExperimentMachineGun::FireBullets( const FireBulletsInfo_t &info )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CExperimentMachineGun::DoMachineGunKick( CBasePlayer *pPlayer, float dampEasy, float maxVerticleKickAngle, float fireDurationTime, float slideLimitTime )
{
...
//-----------------------------------------------------------------------------
bool CExperimentMachineGun::Deploy( void )
{
    m_nShotsFired = 0;
...
//-----------------------------------------------------------------------------
int CExperimentMachineGun::WeaponSoundRealtime( WeaponSound_t shoot_type )
{
    int numBullets = 0;
...
// Purpose:
//-----------------------------------------------------------------------------
void CExperimentMachineGun::ItemPostFrame( void )
{
