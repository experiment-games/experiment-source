...
class CTeamplayRoundBasedRules : public CTeamplayRules, public CGameEventListener
{
    ...
    float GetRoundRestartTime( void ) const
    {
    ...
    // Koth Mode
    virtual bool IsInKothMode( void ) const
    {
        return false;
    }
    ...
    float GetStateTransitionTime( void )
    {
    ...
    {
        return ( CheckTimeLimit( false ) || CheckWinLimit( false ) || CheckMaxRounds( false ) || CheckNextLevelCvar( false ) );
    }
    ...
    float GetPreroundCountdownTime( void )
    {
