...
SHADER_DRAW
{
    ...
    DYNAMIC_STATE
    {
        ...
        float v0[4] = { ( float )( 1.0 / base_texture->GetActualWidth() ), ( float )( 1.0 / base_texture->GetActualHeight() ), ( float )( 1.0 / bloom_texture->GetActualWidth() ), ( float )( 1.0 / bloom_texture->GetActualHeight() ) };
