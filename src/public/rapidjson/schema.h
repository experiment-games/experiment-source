                               ...
                               public internal::IValidationErrorHandler< typename SchemaDocumentType::SchemaType >
{
    ...
    */
    ...
    {
        AddNumberError( SchemaType::GetMaximumString(), ValueType( actual ).Move(), expected, exclusive ? &SchemaType::GetExclusiveMaximumString : 0 );
    }
    ...
    {
        AddNumberError( SchemaType::GetMinimumString(), ValueType( actual ).Move(), expected, exclusive ? &SchemaType::GetExclusiveMinimumString : 0 );
    }
