...
class CDmMeshComp
{
    ...
    class CEdge
    {
        ...
        bool ConnectedTo( const CEdge *pEdge ) const
        {
            return m_pVert0 == pEdge->m_pVert0 || m_pVert0 == pEdge->m_pVert1 || m_pVert1 == pEdge->m_pVert0 || m_pVert1 == pEdge->m_pVert1;
        }
