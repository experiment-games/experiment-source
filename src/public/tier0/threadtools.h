...
{
    Assert( ( size_t )p % 4 == 0 );
    return _InterlockedOr( ( volatile long * )p, value );
}
inline int32 ThreadInterlockedXor( int32 volatile *p, int32 value )
{
    Assert( ( size_t )p % 4 == 0 );
    return _InterlockedXor( ( volatile long * )p, value );
}
inline int32 ThreadInterlockedAnd( int32 volatile *p, int32 value )
{
    Assert( ( size_t )p % 4 == 0 );
    return _InterlockedAnd( ( volatile long * )p, value );
}
inline int32 ThreadInterlockedExchangeAdd( int32 volatile *p, int32 value )
{
    Assert( ( size_t )p % 4 == 0 );
...
{
    Assert( ( size_t )p % 4 == 0 );
    return _InterlockedCompareExchange( ( volatile long * )p, value, comparand );
}
inline bool ThreadInterlockedAssignIf( int32 volatile *p, int32 value, int32 comparand )
{
    Assert( ( size_t )p % 4 == 0 );
    return ( _InterlockedCompareExchange( ( volatile long * )p, value, comparand ) == comparand );
}
...
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedCompareExchange64( ( volatile int64 * )p, value, comparand );
}
inline int64 ThreadInterlockedExchangeAdd64( int64 volatile *p, int64 value )
{
    Assert( ( size_t )p % 8 == 0 );
...
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedExchange64( ( volatile int64 * )p, value );
}
inline int64 ThreadInterlockedOr64( int64 volatile *p, int64 value )
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedOr64( ( volatile int64 * )p, value );
}
inline int64 ThreadInterlockedXor64( int64 volatile *p, int64 value )
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedXor64( ( volatile int64 * )p, value );
}
inline int64 ThreadInterlockedAnd64( int64 volatile *p, int64 value )
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedAnd64( ( volatile int64 * )p, value );
}
inline int64 ThreadInterlockedIncrement64( int64 volatile *p )
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedIncrement64( ( volatile int64 * )p );
}
inline int64 ThreadInterlockedDecrement64( int64 volatile *p )
{
    Assert( ( size_t )p % 8 == 0 );
    return _InterlockedDecrement64( ( volatile int64 * )p );
}
...
{
    return ( void * )( ( intp )ThreadInterlockedExchange( reinterpret_cast< intp volatile * >( p ), reinterpret_cast< intp >( value ) ) );
}
inline void *ThreadInterlockedCompareExchangePointer( void *volatile *p, void *value, void *comparand )
{
    return ( void * )( ( intp )ThreadInterlockedCompareExchange( reinterpret_cast< intp volatile * >( p ), reinterpret_cast< intp >( value ), reinterpret_cast< intp >( comparand ) ) );
}
inline bool ThreadInterlockedAssignPointerIf( void *volatile *p, void *value, void *comparand )
{
    return ( ThreadInterlockedCompareExchange( reinterpret_cast< intp volatile * >( p ), reinterpret_cast< intp >( value ), reinterpret_cast< intp >( comparand ) ) == reinterpret_cast< intp >( comparand ) );
}
#else   // USE_INTRINSIC_INTERLOCKED/PLATFORM_64BITS
inline void *ThreadInterlockedExchangePointer( void *volatile *p, void *value )
{
    return ( void * )( ( intp )ThreadInterlockedExchange64( reinterpret_cast< intp volatile * >( p ), reinterpret_cast< intp >( value ) ) );
}
inline void *ThreadInterlockedCompareExchangePointer( void *volatile *p, void *value, void *comparand )
{
...
inline bool ThreadInterlockedAssignPointerIf( void *volatile *p, void *value, void *comparand )
{
    return ( ThreadInterlockedCompareExchange64( reinterpret_cast< intp volatile * >( p ), reinterpret_cast< intp >( value ), reinterpret_cast< intp >( comparand ) ) == reinterpret_cast< intp >( comparand ) );
}
...
inline void const *ThreadInterlockedCompareExchangePointerToConst( void const *volatile *p, void const *value, void const *comparand )
{
    return ThreadInterlockedCompareExchangePointer( const_cast< void *volatile * >( p ), const_cast< void * >( value ), const_cast< void * >( comparand ) );
}
inline bool ThreadInterlockedAssignPointerToConstIf( void const *volatile *p, void const *value, void const *comparand )
{
    return ThreadInterlockedAssignPointerIf( const_cast< void *volatile * >( p ), const_cast< void * >( value ), const_cast< void * >( comparand ) );
}
...
inline unsigned ThreadInterlockedOr( uint32 volatile *p, uint32 value )
{
    return ThreadInterlockedOr( ( int32 volatile * )p, value );
}
inline unsigned ThreadInterlockedAnd( uint32 volatile *p, uint32 value )
{
    return ThreadInterlockedAnd( ( int32 volatile * )p, value );
}
...
inline unsigned ThreadInterlockedCompareExchange( uint32 volatile *p, uint32 value, uint32 comparand )
{
    return ThreadInterlockedCompareExchange( ( int32 volatile * )p, value, comparand );
}
inline bool ThreadInterlockedAssignIf( uint32 volatile *p, uint32 value, uint32 comparand )
{
    return ThreadInterlockedAssignIf( ( int32 volatile * )p, value, comparand );
}
...
inline unsigned ThreadInterlockedExchangeSubtract( uint32 volatile *p, uint32 value )
{
    return ThreadInterlockedExchangeAdd( ( int32 volatile * )p, -( int32 )value );
}
...
class CInterlockedIntT
{
   public:
    CInterlockedIntT()
        : m_value( 0 )
    {
        COMPILE_TIME_ASSERT( ( sizeof( T ) == sizeof( int32 ) ) || ( sizeof( T ) == sizeof( int64 ) ) );
    }
...
class CAutoLockT
{
   public:
    FORCEINLINE CAutoLockT( MUTEX_TYPE &lock, const char *pMutexName, const char *pFilename, int nLineNum, uint64 minReportDurationUs )
        : m_lock( const_cast< typename V_remove_const< MUTEX_TYPE >::type & >( lock ) ), m_pMutexName( pMutexName ), m_pFilename( pFilename ), m_nLineNum( nLineNum ), m_bOwned( true )
    {
