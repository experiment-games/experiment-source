...
void CTHash< Data, I >::Init( int cRecordInit, int cBucket )
{
    ...
    m_pMemoryPoolRecord = new CUtlMemoryPool( sizeof( Data ) + sizeof( RecHdr_t ), cRecordInit, CUtlMemoryPool::GROW_SLOW );
