...
struct base_vector_t
{
   public:
    ...
    {
        IsUtlVector = true
    };  // Used to match this at compiletime
};
...
class CUtlVectorMT : public BASE_UTLVECTOR, public MUTEX_TYPE
{
   ...
   public:
    ...
    CUtlVectorMT( typename BaseClass::ElemType_t *pMemory, int numElements )
...
class CUtlVectorConservative : public CUtlVector< T, CUtlMemoryConservative< T > >
{
   ...
   public:
    ...
    explicit CUtlVectorConservative( int growSize = 0, int initSize = 0 )
        : BaseClass( growSize, initSize ) {}
    CUtlVectorConservative( T *pMemory, int numElements )
        : BaseClass( pMemory, numElements ) {}
};
...
class CUtlVectorUltraConservative : private A
{
   public:
    ...
    bool DebugCompileError_ANonVectorIsUsedInThe_FOR_EACH_VEC_Macro( void ) const
    {
        return true;
    }
...
class CCopyableUtlVectorFixedGrowable : public CUtlVectorFixedGrowable< T, MAX_SIZE >
{
   ...
   public:
    ...
    CCopyableUtlVectorFixedGrowable( CCopyableUtlVectorFixedGrowable const &vec )
    {
        this->CopyArray( vec.Base(), vec.Count() );
    }
};
...
class CCopyableUtlVectorFixed : public CUtlVectorFixed< T, MAX_SIZE >
{
   ...
   public:
    ...
    CCopyableUtlVectorFixed( CCopyableUtlVectorFixed const &vec )
    {
        this->CopyArray( vec.Base(), vec.Count() );
    }
};
