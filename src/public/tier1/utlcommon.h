...
{
    unsigned int operator()( uint64 s ) const;
};
...
struct PointerHashFunctor
{
    ...
    {
        return Mix64HashFunctor()( ( uintp )s );
    }
};
#else
struct PointerHashFunctor
{
    unsigned int operator()( const void *s ) const
    {
        return Mix32HashFunctor()( ( uintp )s );
    }
};
#endif
...
#elif defined( POSIX )
template <>
struct DefaultHashFunctor< signed long > : Mix64HashFunctor
{
};
template <>
struct DefaultHashFunctor< unsigned long > : Mix64HashFunctor
{
};
#endif
template <>
struct DefaultHashFunctor< signed long long > : Mix64HashFunctor
{
};
template <>
struct DefaultHashFunctor< unsigned long long > : Mix64HashFunctor
{
};
template <>
