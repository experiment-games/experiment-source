...
struct SearchForGameProgressCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 1
    };
...
struct SearchForGameResultCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 2
    };
...
struct RequestPlayersForGameProgressCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 11
    };
...
struct RequestPlayersForGameResultCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 12
    };
...
struct RequestPlayersForGameFinalResultCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 13
    };
...
struct SubmitPlayerResultResultCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 14
    };
...
struct EndGameResultCallback_t
{
    enum
    {
        k_iCallback = k_iSteamGameSearchCallbacks + 15
    };
...
struct JoinPartyCallback_t
{
    enum
    {
        k_iCallback = k_iSteamPartiesCallbacks + 1
    };
...
struct CreateBeaconCallback_t
{
    enum
    {
        k_iCallback = k_iSteamPartiesCallbacks + 2
    };
...
struct ReservationNotificationCallback_t
{
    enum
    {
        k_iCallback = k_iSteamPartiesCallbacks + 3
    };
...
struct ChangeNumOpenSlotsCallback_t
{
    enum
    {
        k_iCallback = k_iSteamPartiesCallbacks + 4
    };
...
struct AvailableBeaconLocationsUpdated_t
{
    enum
    {
        k_iCallback = k_iSteamPartiesCallbacks + 5
    };
};
...
struct ActiveBeaconsUpdated_t
{
    enum
    {
        k_iCallback = k_iSteamPartiesCallbacks + 6
    };
};
