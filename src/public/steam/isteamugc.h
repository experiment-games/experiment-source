...
struct SteamUGCQueryCompleted_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 1
    };
...
struct SteamUGCRequestUGCDetailsResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 2
    };
...
struct CreateItemResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 3
    };
    EResult m_eResult;
...
struct SubmitItemUpdateResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 4
    };
    EResult m_eResult;
    bool m_bUserNeedsToAcceptWorkshopLegalAgreement;
    PublishedFileId_t m_nPublishedFileId;
...
struct ItemInstalled_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 5
    };
    AppId_t m_unAppID;
    PublishedFileId_t m_nPublishedFileId;
};
...
struct DownloadItemResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 6
    };
    AppId_t m_unAppID;
    PublishedFileId_t m_nPublishedFileId;
    EResult m_eResult;
...
struct UserFavoriteItemsListChanged_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 7
    };
    PublishedFileId_t m_nPublishedFileId;
    EResult m_eResult;
...
struct SetUserItemVoteResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 8
    };
    PublishedFileId_t m_nPublishedFileId;
    EResult m_eResult;
    bool m_bVoteUp;
...
struct GetUserItemVoteResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 9
    };
    PublishedFileId_t m_nPublishedFileId;
    EResult m_eResult;
    bool m_bVotedUp;
...
struct StartPlaytimeTrackingResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 10
    };
    EResult m_eResult;
};
...
struct StopPlaytimeTrackingResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 11
    };
    EResult m_eResult;
};
...
struct AddUGCDependencyResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 12
    };
    EResult m_eResult;
    PublishedFileId_t m_nPublishedFileId;
...
struct RemoveUGCDependencyResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 13
    };
    EResult m_eResult;
    PublishedFileId_t m_nPublishedFileId;
    PublishedFileId_t m_nChildPublishedFileId;
...
struct AddAppDependencyResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 14
    };
    EResult m_eResult;
    PublishedFileId_t m_nPublishedFileId;
    AppId_t m_nAppID;
...
struct RemoveAppDependencyResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 15
    };
    EResult m_eResult;
    PublishedFileId_t m_nPublishedFileId;
    AppId_t m_nAppID;
...
struct GetAppDependenciesResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 16
    };
    EResult m_eResult;
    PublishedFileId_t m_nPublishedFileId;
...
struct DeleteItemResult_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 17
    };
    EResult m_eResult;
    PublishedFileId_t m_nPublishedFileId;
};
...
struct UserSubscribedItemsListChanged_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 18
    };
    AppId_t m_nAppID;
};
...
struct WorkshopEULAStatus_t
{
    enum
    {
        k_iCallback = k_iSteamUGCCallbacks + 20
    };
    EResult m_eResult;
    AppId_t m_nAppID;
    uint32 m_unVersion;
