...
inline ISteamUser* SteamAPI_SteamUser()
{
...
inline ISteamFriends* SteamAPI_SteamFriends()
{
...
inline ISteamUtils* SteamAPI_SteamUtils()
{
...
inline ISteamUtils* SteamAPI_SteamGameServerUtils()
{
...
inline ISteamMatchmaking* SteamAPI_SteamMatchmaking()
{
...
inline ISteamMatchmakingServers* SteamAPI_SteamMatchmakingServers()
{
...
inline ISteamGameSearch* SteamAPI_SteamGameSearch()
{
...
inline ISteamParties* SteamAPI_SteamParties()
{
...
inline ISteamRemoteStorage* SteamAPI_SteamRemoteStorage()
{
...
inline ISteamUserStats* SteamAPI_SteamUserStats()
{
...
inline ISteamApps* SteamAPI_SteamApps()
{
...
inline ISteamNetworking* SteamAPI_SteamNetworking()
{
...
inline ISteamNetworking* SteamAPI_SteamGameServerNetworking()
{
...
inline ISteamScreenshots* SteamAPI_SteamScreenshots()
{
...
inline ISteamMusic* SteamAPI_SteamMusic()
{
...
inline ISteamMusicRemote* SteamAPI_SteamMusicRemote()
{
...
inline ISteamHTTP* SteamAPI_SteamHTTP()
{
...
inline ISteamHTTP* SteamAPI_SteamGameServerHTTP()
{
...
inline ISteamInput* SteamAPI_SteamInput()
{
...
inline ISteamController* SteamAPI_SteamController()
{
...
inline ISteamUGC* SteamAPI_SteamUGC()
{
...
inline ISteamUGC* SteamAPI_SteamGameServerUGC()
{
    return SteamAPI_SteamGameServerUGC_v017();
}
...
inline ISteamAppList* SteamAPI_SteamAppList()
{
...
inline ISteamHTMLSurface* SteamAPI_SteamHTMLSurface()
{
...
inline ISteamInventory* SteamAPI_SteamInventory()
{
...
inline ISteamInventory* SteamAPI_SteamGameServerInventory()
{
...
inline ISteamVideo* SteamAPI_SteamVideo()
{
...
inline ISteamParentalSettings* SteamAPI_SteamParentalSettings()
{
...
inline ISteamRemotePlay* SteamAPI_SteamRemotePlay()
{
...
inline ISteamNetworkingMessages* SteamAPI_SteamNetworkingMessages_SteamAPI()
{
...
inline ISteamNetworkingMessages* SteamAPI_SteamGameServerNetworkingMessages_SteamAPI()
{
...
inline ISteamNetworkingSockets* SteamAPI_SteamNetworkingSockets_SteamAPI()
{
...
inline ISteamNetworkingSockets* SteamAPI_SteamGameServerNetworkingSockets_SteamAPI()
{
...
inline ISteamNetworkingUtils* SteamAPI_SteamNetworkingUtils_SteamAPI()
{
...
inline ISteamGameServer* SteamAPI_SteamGameServer()
{
...
inline ISteamGameServerStats* SteamAPI_SteamGameServerStats()
{
