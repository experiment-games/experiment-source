...
struct RemoteStorageFileShareResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 7
    };
...
struct RemoteStoragePublishFileResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 9
    };
    EResult m_eResult;  // The result of the operation.
...
struct RemoteStorageDeletePublishedFileResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 11
    };
    EResult m_eResult;  // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;
};
...
struct RemoteStorageEnumerateUserPublishedFilesResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 12
    };
    EResult m_eResult;  // The result of the operation.
...
struct RemoteStorageSubscribePublishedFileResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 13
    };
    EResult m_eResult;  // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;
};
...
struct RemoteStorageEnumerateUserSubscribedFilesResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 14
    };
    EResult m_eResult;  // The result of the operation.
    int32 m_nResultsReturned;
    int32 m_nTotalResultCount;
...
struct RemoteStorageUnsubscribePublishedFileResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 15
    };
    EResult m_eResult;  // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;
};
...
struct RemoteStorageUpdatePublishedFileResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 16
    };
    EResult m_eResult;  // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;
    bool m_bUserNeedsToAcceptWorkshopLegalAgreement;
...
struct RemoteStorageDownloadUGCResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 17
    };
    EResult m_eResult;                     // The result of the operation.
...
struct RemoteStorageGetPublishedFileDetailsResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 18
    };
    EResult m_eResult;  // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;
...
struct RemoteStorageEnumerateWorkshopFilesResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 19
    };
    EResult m_eResult;
    int32 m_nResultsReturned;
    int32 m_nTotalResultCount;
...
struct RemoteStorageGetPublishedItemVoteDetailsResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 20
    };
    EResult m_eResult;
...
struct RemoteStoragePublishedFileSubscribed_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 21
    };
...
struct RemoteStoragePublishedFileUnsubscribed_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 22
    };
    PublishedFileId_t m_nPublishedFileId;  // The published file id
    AppId_t m_nAppID;                      // ID of the app that will consume this file.
};
...
struct RemoteStoragePublishedFileDeleted_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 23
    };
    PublishedFileId_t m_nPublishedFileId;  // The published file id
    AppId_t m_nAppID;                      // ID of the app that will consume this file.
};
...
struct RemoteStorageUpdateUserPublishedItemVoteResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 24
    };
    EResult m_eResult;                     // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;  // The published file id
};
...
struct RemoteStorageUserVoteDetails_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 25
    };
    EResult m_eResult;                     // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;  // The published file id
...
struct RemoteStorageEnumerateUserSharedWorkshopFilesResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 26
    };
    EResult m_eResult;  // The result of the operation.
    int32 m_nResultsReturned;
    int32 m_nTotalResultCount;
...
struct RemoteStorageSetUserPublishedFileActionResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 27
    };
    EResult m_eResult;                     // The result of the operation.
    PublishedFileId_t m_nPublishedFileId;  // The published file id
...
struct RemoteStorageEnumeratePublishedFilesByUserActionResult_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 28
    };
    EResult m_eResult;              // The result of the operation.
...
struct RemoteStoragePublishFileProgress_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 29
    };
...
struct RemoteStoragePublishedFileUpdated_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 30
    };
    PublishedFileId_t m_nPublishedFileId;  // The published file id
    AppId_t m_nAppID;                      // ID of the app that will consume this file.
...
struct RemoteStorageFileWriteAsyncComplete_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 31
    };
...
struct RemoteStorageFileReadAsyncComplete_t
{
    enum
    {
        k_iCallback = k_iSteamRemoteStorageCallbacks + 32
    };
