...
class CSteamID
{
   public:
    ...
    // Source: https://github.com/SteamRE/SteamKit/blob/master/Resources/NetHook2/NetHook2/steam/csteamid.h#L342
    ...
    bool IsValid() const
    {
        ...
        switch ( m_gameID.m_nType )
        {
            ...
            case k_EGameIDTypeShortcut:
                return m_gameID.m_nAppID == k_uAppIdInvalid && ( m_gameID.m_nModID & 0x80000000 ) && m_gameID.m_nModID >= ( 5000 | 0x80000000 );  // k_unMaxExpectedLocalAppId - shortcuts are pushed beyond that range
