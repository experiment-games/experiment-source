...
struct UnreadChatMessagesChanged_t
{
    enum
    {
        k_iCallback = k_iSteamFriendsCallbacks + 48
    };
};
...
struct OverlayBrowserProtocolNavigation_t
{
    enum
    {
        k_iCallback = k_iSteamFriendsCallbacks + 49
    };
    char rgchURI[1024];
};
...
struct EquippedProfileItemsChanged_t
{
    enum
    {
        k_iCallback = k_iSteamFriendsCallbacks + 50
    };
    CSteamID m_steamID;
};
...
struct EquippedProfileItems_t
{
    enum
    {
        k_iCallback = k_iSteamFriendsCallbacks + 51
    };
    EResult m_eResult;
    CSteamID m_steamID;
