...
{
    matrix3x4_t matrix = luaL_checkmatrix( L, 1 );
    lua_pushfstring( L, "matrix3x4_t: %f, %f, %f, %f\n             %f, %f, %f, %f\n             %f, %f, %f, %f", matrix[0][0], matrix[0][1], matrix[0][2], matrix[0][3], matrix[1][0], matrix[1][1], matrix[1][2], matrix[1][3], matrix[2][0], matrix[2][1], matrix[2][2], matrix[2][3] );
    return 1;
}
...
static const luaL_Reg matrix3x4_t_funcs[] = {
    { LUA_MATRIXLIBNAME, luasrc_matrix3x4_t },
    { NULL, NULL } };
