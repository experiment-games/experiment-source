...
{
    lua_QAngle angle = luaL_checkangle( L, 1 );
    angle.Init( luaL_optnumber( L, 2, 0.0f ), luaL_optnumber( L, 3, 0.0f ), luaL_optnumber( L, 4, 0.0f ) );
...
{
    lua_QAngle angle = luaL_checkangle( L, 1 );
    lua_Vector axis = luaL_checkvector( L, 2 );
...
{
    lua_QAngle angle = luaL_checkangle( L, 1 );
    lua_QAngle angleToAdd = luaL_checkangle( L, 2 );
