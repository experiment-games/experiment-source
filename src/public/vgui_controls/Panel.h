...
class Panel : public IClientPanel, virtual public IForceVirtualInheritancePanel
{
   ...
   public:
    ...
    PHandle GetMouseHandlerPanel() const
    {
        return m_hMouseEventHandler;
    }
    ...
    {
        return GetSchemeColor( pszColorName, vgui::scheme()->GetIScheme( GetScheme() ) );
    }
