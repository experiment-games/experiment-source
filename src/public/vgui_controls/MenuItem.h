...
class MenuItem : public Button
{
    ...
    void SetOffsetFromMainMenu( int nOffset )
    {
        m_nOffsetFromMainMenu = nOffset;
    }
    int GetOffsetFromMainMenu() const
    {
        return m_nOffsetFromMainMenu;
    }

    void SetPaddingY( int nPadding )
    {
        m_nPaddingY = nPadding;
    }
