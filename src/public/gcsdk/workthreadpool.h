...
#define DECLARE_WORK_ITEM( classname )                   \
    virtual const char *GetDispatchCompletedName() const \
    {                                                    \
        return #classname "::DispatchCompleted";         \
    }                                                    \
    virtual const char *GetThreadProcessName() const     \
    {                                                    \
        return #classname "::ThreadProcess";             \
    }
...
class CWorkItem : public CRefCount
{
   public:
    ...
    {
        return m_jobtimeTimeout.LTime() != 0 && m_jobtimeTimeout.CServerMicroSecsPassed() > 0;
    }
    int64 WaitingTime() const
    {
        return m_jobtimeQueued.CServerMicroSecsPassed();
    }
    void SetPreExecuteTimeout( int64 cMicroSeconds )
    {
        m_jobtimeTimeout.SetFromJobTime( cMicroSeconds );
    }
    bool BPreExecuteTimeoutSet() const
    {
        return m_jobtimeTimeout.LTime() != 0;
    }
    void ForceTimeOut()
    {
        m_jobtimeTimeout.SetFromJobTime( -1 );
    }
    bool BIsRunning() const
    {
        return m_bRunning;
    }  // true if running right now
    bool WasCancelled() const
    {
        return m_bCanceled;
    }
    void SetCycleCount( CCycleCount &cycleCount )
    {
        m_CycleCount = cycleCount;
    }
    CCycleCount GetCycleCount()
    {
        return m_CycleCount;
    }
    ...
    void SetResubmit( bool bResubmit )
    {
        m_bResubmit = bResubmit;
    }
...
class CWorkThreadPool
{
   ...
   public:
    ...
    void SetEnsureOutputOrdering( bool bEnsureOutputOrdering )
    {
        m_bEnsureOutputOrdering = bEnsureOutputOrdering;
    }

    void AllowTimeouts( bool bMayHaveJobTimeouts )
    {
        m_bMayHaveJobTimeouts = bMayHaveJobTimeouts;
    }
    ...
    const char *GetThreadNamePrefix() const
    {
        return m_szThreadNamePfx;
    }

    void SetNeverSetEventOnAdd( bool bNeverSet );
    bool BNeverSetEventOnAdd()
    {
        return m_bNeverSetOnAdd;
    }
    ...
    int CountRetries() const
    {
        return m_cRetries;
    }
    int CountCompletedFailed() const
    {
        return m_cFailures;
    }
    ...
    {
        return m_WorkThreads.Count();
    }

    uint GetActiveThreadCount() const
    {
        return m_cActiveThreads;
    }
