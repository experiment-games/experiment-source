...
class CSharedObjectTypeCache
{
   public:
    ...
    {
        return m_vecObjects.Count();
    }
    CSharedObject *GetObject( uint32 nObj )
    {
        return m_vecObjects[nObj];
    }
    const CSharedObject *GetObject( uint32 nObj ) const
    {
        return m_vecObjects[nObj];
    }
...
class CSharedObjectCache
{
   public:
    ...
    void SetVersion( uint64 ulVersion )
    {
   ...
   protected:
    ...
    {
        return m_mapObjects.IsValidIndex( nIndex ) ? m_mapObjects.Element( nIndex ) : NULL;
    }
    int GetTypeCacheCount() const
    {
        return m_mapObjects.MaxElement();
    }

    int FirstTypeCacheIndex()
    {
        return m_mapObjects.FirstInorder();
    }
    int NextTypeCacheIndex( int iCurrent )
    {
        return m_mapObjects.NextInorder( iCurrent );
    }
    int InvalidTypeCacheIndex()
    {
        return m_mapObjects.InvalidIndex();
    }
