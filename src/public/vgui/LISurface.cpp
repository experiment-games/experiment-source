...
{
    surface()->DrawSetTextureFile( luaL_checkint( L, 1 ), luaL_checkstring( L, 2 ), luaL_optint( L, 3, 0 ), luaL_optboolean( L, 4, true ) );
    return 0;
}
...
{
    g_pMatSystemSurface->DrawSetTextureMaterial( luaL_checkint( L, 1 ), luaL_checkmaterial( L, 2 ) );
    return 0;
}
