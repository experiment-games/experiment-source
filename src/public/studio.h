...
struct studiohdr_t
{
...
#ifdef PLATFORM_64BITS
    void *VirtualModel() const
    {
        return studiohdr2index ? ( void * )( pStudioHdr2()->virtualModel ) : nullptr;
    }
    void SetVirtualModel( void *ptr )
    {
        ...
        if ( studiohdr2index )
        {
            pStudioHdr2()->virtualModel = ptr;
        }
    }

    void *VertexBase() const
    {
        return studiohdr2index ? ( void * )( pStudioHdr2()->pVertexBase ) : nullptr;
    }
    void SetVertexBase( void *pVertexBase ) const
    {
        Assert( studiohdr2index );
        if ( studiohdr2index )
        {
            pStudioHdr2()->pVertexBase = pVertexBase;
        }
    }
    void *IndexBase() const
    {
        return studiohdr2index ? ( void * )( pStudioHdr2()->pIndexBase ) : nullptr;
    }
    void SetIndexBase( void *pIndexBase ) const
    {
        Assert( studiohdr2index );
        if ( studiohdr2index )
        {
            pStudioHdr2()->pIndexBase = pIndexBase;
        }
    }
#else
    void *VirtualModel() const
    ...
    void SetVertexBase( void *_pVertexBase ) const
    {
        pVertexBase = _pVertexBase;
    }
    void *IndexBase() const
    {
        return pIndexBase;
    }
    void SetIndexBase( void *_pIndexBase ) const
    {
        pIndexBase = _pIndexBase;
    }
#endif
