...
#define MAXSTUDIOBONES 256      // total bones actually used // Experiment: Was 128 before.
...
inline bool Studio_ConvertStudioHdrToNewVersion( studiohdr_t *pStudioHdr )
{
    ...
    // Experiment; TODO: STUDIO_FRAMEANIM https://github.com/NicolasDe/AlienSwarm/blob/c5a2d3fa853c726d040032ff2c7b90c8ed8d5d84/src/public/studio.h#L3189 (low priority if things work)
    //if ( version < 49 )
    //{
