...
class CReplayTime
{
    ...
    static const wchar_t *GetLocalizedDate( vgui::ILocalize *pLocalize, int nDay, int nMonth, int nYear, int *pHour = NULL, int *pMin = NULL, int *pSec = NULL, bool bForceFullFormat = false );  // bForceFullFormat true will keep from returning "today" or "yesterday"
